...
model SteamDrum_Astrom_Bell_Zuber_Corr_step_W_direct
  ...
  input Real k_sd(start=0.44705737);
...
equation
  ...
  Drum.V_sd = V_sd;
  Drum.x_r = x_r;
  //Drum.A_sep = 15; // This value is a guess and will be corrected by k_sd
...
end SteamDrum_Astrom_Bell_Zuber_Corr_step_W_direct;
