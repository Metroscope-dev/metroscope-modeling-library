...
model Condenser_LMTD_test "Added more info on fins and used ESCOA correlation"
 import MetroscopeModelingLibrary.Utilities.Units;
  ...
  package WaterSteamMedium = MetroscopeModelingLibrary.Utilities.Media.WaterSteamMedium;
    ...
    //Units.Temperature T_wall(start=T_wall_0+273.15) "Wall temperature";
    Units.Temperature DT_a "LMTD DTa";
    Units.Temperature DT_b "LMTD DTb";
     Units.Temperature DT_LM "LMTD";
     Units.Temperature DT_LM_calc "LMTD";
    // Pressures
    ...
    // ------ Initialization ------
    parameter Units.Temperature T_wall_0 = 22;
    ...
    parameter Modelica.Units.SI.ThermalConductance UA_0 = 25e6;
...
//   end if;
  ...
  // DT LMTD
    DT_a = T_hot_sat - T_cold_out;
    DT_b = T_hot_sat - T_cold_in;
//     DT_LM = (DT_a - DT_b)/(log(DT_a/DT_b));
    //DT_LM = T_wall - (T_cold_in + T_cold_out)/2;
    DT_LM_calc = (DT_a - DT_b)/(log(DT_a/DT_b));

  // Energy Balance
    W_cold + W_hot = 0;
    DT_LM = W_cold/UA;
    //T_cold_out = W_cold/(Q_cold
    //0 = T_wall - T_cold_out - (T_wall - T_cold_in)*exp(UA_cold*((T_cold_in - T_cold_out)/W_cold));
