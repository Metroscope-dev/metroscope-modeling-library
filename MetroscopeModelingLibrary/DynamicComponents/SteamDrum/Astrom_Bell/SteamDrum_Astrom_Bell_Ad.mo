...
model SteamDrum_Astrom_Bell_Ad "A simple heat exchange with the flue gas as integrated, as well as a water extraction"
  ...
  // Parameters
    ...
    Inputs.InputReal beta "Constant";
    Inputs.InputReal T_d "Steam residence time in the drum";
