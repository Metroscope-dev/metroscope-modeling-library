...
model RefMoistAir_to_FlueGases

  package FlueGasesMedium = MetroscopeModelingLibrary.Utilities.Media.FlueGasesMedium;

  RefMoistAir.Connectors.Inlet inlet annotation (Placement(transformation(extent={{-110,-10},{-90,10}})));
  RefMoistAir.BoundaryConditions.Sink sink annotation (Placement(transformation(extent={{-32,-10},{-12,10}})));
