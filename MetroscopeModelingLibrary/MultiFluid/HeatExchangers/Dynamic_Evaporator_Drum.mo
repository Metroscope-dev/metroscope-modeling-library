...
model Dynamic_Evaporator_Drum "A simple heat exchange with the flue gas as integrated, as well as a water extraction"
  ...
  parameter Boolean steady_state = false "true: sets the time derivatives to zero"
  annotation(Dialog(tab="General", group="Modes"));

  // Design and geometry parameters
  parameter Units.Length D = 2.5 "Drum diameter" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Units.Length r = D/2 "Drum radius" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Units.Length L = 11 "Drum length" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Units.Volume V_D = 40 "Drum volume" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Units.Volume V_r = 37 "Riser volume" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Units.Volume V_dc = 11 "Downcomers volume" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Units.Mass M_d = 0 "Drum mass" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Units.Mass M_r = 160000 "Riser mass" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Units.Mass M_t = 300000 "Total mass of the system" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Units.Area A_dc = 0.4 "Downcomers cross sectional surface" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Units.Area A_d = 20 "Drum wet area at normal operating level" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Units.HeatCapacity Cp = 550 "Heat capacity of the metal" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Units.Area A_fg_tubes = 3283.7 "Tubes heat exchange surface" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Units.Area A_fg_fins = 58635.5 "Fins exchange surface" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Real eta_fins = 0.8 annotation(Dialog(tab="General", group="Design and geometry"));


  // Dynamic parameters
  parameter Real beta = 0.3 "Constant" annotation(Dialog(tab="General", group="Dynamic parameters"));
  parameter Real T_d = 12 "Steam residence time in the drum" annotation(Dialog(tab="General", group="Dynamic parameters"));
  parameter Units.Height l_0 = 0 "Nominal level" annotation(Dialog(tab="General", group="Dynamic parameters"));
  parameter Units.FrictionCoefficient k = 366 "Friction coefficient in the downcomers";
  parameter Units.Volume V_0_sd = 7.6 "Hypothetical volume of bubbles";


  // Initialization parameters
    parameter Units.Pressure p_0 = 85e5 annotation(Dialog(tab="General", group="Initialization"));
    parameter Units.Volume V_wt_0 = 57.2 annotation(Dialog(tab="General", group="Initialization"));
  ...
  Utilities.Interfaces.GenericReal K_conv_fg annotation (Placement(transformation(extent={{-80,-304},{-88,-296}}), iconTransformation(extent={{-76,-304},{-84,-296}})));
equation
