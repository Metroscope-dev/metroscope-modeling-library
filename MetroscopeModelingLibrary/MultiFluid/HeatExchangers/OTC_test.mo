...
equation
  ...
  connect(superheater.C_cold_out, C_cold_out) annotation (Line(
      ...
      color={28,108,200},
      thickness=1));
  connect(superheater.C_cold_in, C_cold_in) annotation (Line(points={{-140,62},{
          -140,92},{40,92}}, color={28,108,200}));
  connect(Kfr_hot_pipe.C_out, C_hot_out)
    annotation (Line(points={{-80,12},{60,12}}, color={95,95,95}));
