...
model Sink
    replaceable package Medium =
      ...
      Modelica.SIunits.MassFlowRate Q_in(start=500);
      Modelica.SIunits.VolumeFlowRate Qv_in(start=500);
      Modelica.SIunits.AbsolutePressure P_in(start=1e5);
      Modelica.SIunits.Temperature T_in(start=293.15);
      Modelica.SIunits.Temperature T_vol(start=293.15);
      Modelica.SIunits.SpecificEnthalpy h_in(start=1e5);
