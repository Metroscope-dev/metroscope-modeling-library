...
model FlashTank_Reheater
  ...
  MetroscopeModelingLibrary.WaterSteam.BoundaryConditions.Source source_hot_SatSteam_1
    annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={-4,78})));
  MetroscopeModelingLibrary.WaterSteam.Junctions.FlashTank flashTank(P_0=11e5, Q_liq_0=1e-3, Q_vap_0=Q_hot_0, use_homotopy=test_use_homotopy)
  ...
  MetroscopeModelingLibrary.WaterSteam.BoundaryConditions.Source source_hot_SatSteam_2
    annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={-132,76})));
  MetroscopeModelingLibrary.WaterSteam.PressureLosses.PipePressureLoss DPz(Q_in_0 = Q_hot_0, use_homotopy=test_use_homotopy)
    annotation (Placement(transformation(
        extent={{-12.5,-12.5},{12.5,12.5}},
        rotation=180,
        origin={-34.5,8.5})));
  MetroscopeModelingLibrary.WaterSteam.Machines.StaticCentrifugalPump PRP(Q_0=Q_hot_0/3, use_homotopy=test_use_homotopy)
    annotation (Placement(transformation(
        extent={{9,-9},{-9,9}},
        rotation=0,
        origin={-115,-69})));
  MetroscopeModelingLibrary.WaterSteam.PressureLosses.SingularPressureLoss DP_vaporBalance(Q_0=Q_hot_0/2, use_homotopy=test_use_homotopy)
