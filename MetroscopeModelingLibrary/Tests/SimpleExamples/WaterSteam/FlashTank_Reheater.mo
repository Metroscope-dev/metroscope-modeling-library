...
model FlashTank_Reheater
  ...
  MetroscopeModelingLibrary.WaterSteam.BoundaryConditions.Source source_hot_SatSteam_1
    annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={-4,78})));
  MetroscopeModelingLibrary.WaterSteam.Junctions.FlashTank flashTank(P_0=11e5, Q_liq_0=0, Q_vap_0=Q_hot_0, use_homotopy=use_homotopy)
  ...
  MetroscopeModelingLibrary.WaterSteam.BoundaryConditions.Source source_hot_SatSteam_2
    annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={-132,76})));
  MetroscopeModelingLibrary.WaterSteam.PressureLosses.PipePressureLoss DPz(Q_0=Q_hot_0, use_homotopy=use_homotopy)
    annotation (Placement(transformation(
