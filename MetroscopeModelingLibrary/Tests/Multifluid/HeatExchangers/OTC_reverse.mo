...
model OTC_reverse
  ...
  MetroscopeModelingLibrary.FlueGases.BoundaryConditions.Source hot_source(h_out(
        start=500000))
  ...
  MetroscopeModelingLibrary.WaterSteam.BoundaryConditions.Source cold_source(h_0=
        167327.44)
  ...
  Utilities.Interfaces.RealOutput Kfr_cold annotation (Placement(transformation(
          extent={{-62,-44},{-54,-36}}), iconTransformation(extent={{-282,54},{-262,
            74}})));
  Sensors_Control.WaterSteam.FlowSensor Q_cold_sensor(Q_start=85)
  ...
  Sensors_Control.WaterSteam.TemperatureSensor T_cold_out_sensor(
      sensor_function="BC", T_start=515)
