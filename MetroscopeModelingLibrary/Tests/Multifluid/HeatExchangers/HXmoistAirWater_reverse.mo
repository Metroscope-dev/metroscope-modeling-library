...
model HXmoistAirWater_reverse
 ...
 // Boundary conditions
  ...
  MetroscopeModelingLibrary.WaterSteam.BoundaryConditions.Sink hot_sink annotation (Placement(transformation(extent={{24,64},{44,84}})));
...
equation
  ...
  connect(P_hot_out_sensor.C_in, hXmoistAirWater.C_hot_out) annotation (Line(points={{-5.55112e-16,24},{-2,8},{-2,12}},
                                                                                                                      color={28,108,200}));
  connect(hot_sink.C_in, T_hot_out_sensor.C_out) annotation (Line(points={{29,74},{29,70},{5.55112e-16,70}},
                                                                                                           color={28,108,200}));
