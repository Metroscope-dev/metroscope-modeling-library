...
model CoolingTowerPoppe_reverse
  ...
  MultiFluid.HeatExchangers.CoolingTowerPoppe  CoolingTower annotation (Placement(transformation(extent={{-10,-30},{10,-10}})));
...
equation
  ...
  connect(CoolingTower.C_hot_in, waterInletPress_sensor.C_out) annotation (Line(points={{-7.5,-20},{-16,-20}},
                                                                                                         color={28,108,200}));
  ...
  connect(waterInletPress_sensor.C_in,waterInletTemp_sensor. C_out) annotation (Line(points={{-36,-20},{-48,-20}},
                                                                                                               color={28,108,200}));
  connect(CoolingTower.C_hot_out, WaterOutletTemp_sensor.C_in) annotation (Line(points={{7.5,-20},{34,-20}},
                                                                                                       color={28,108,200}));
  ...
  connect(airInletPress_sensor.C_out, CoolingTower.C_cold_in) annotation (Line(points={{0,0},{0,-12.5}},                                       color={85,170,255}));
  connect(CoolingTower.C_cold_out, airOutletPress_sensor.C_in) annotation (Line(points={{0,-27.5},{0,-34}},                                       color={85,170,255}));
