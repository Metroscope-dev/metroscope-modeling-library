...
model DeltaPressureSensor
  ...
  MetroscopeModelingLibrary.Sensors.FlueGases.DeltaPressureSensor DP_sensor annotation (Placement(transformation(extent={{-10,10},{10,30}})));
...
equation
  ...
  connect(source.C_out, FlueGasesIsoHFlowModel.C_in) annotation (Line(points={{-43,0},{-10,0}}, color={28,108,200}));
  connect(FlueGasesIsoHFlowModel.C_out, sink.C_in) annotation (Line(points={{10,0},{43,0}}, color={28,108,200}));
  connect(DP_sensor.C_in, FlueGasesIsoHFlowModel.C_in) annotation (Line(points={{-10,20},{-20,20},{-20,0},{-10,0}}, color={28,108,200}));
