...
equation
  // Boundary conditions
  turbine_source.h_out = 2915.5e3;
  turbine_source.P_out = 11.17e5;
  turbine_sink.P_in = 52e2;

  //pump_source.T_out = 182.0 + 273.15;
  pump_source.h_out = 773.5e3;
  pump_source.P_out = 40.167e5;
