...
model Pipe_reverse
  ...
  Utilities.Interfaces.RealOutput Kfr annotation (Placement(transformation(
        extent={{-4,-4},{4,4}},
        rotation=270,
        origin={0,20}), iconTransformation(extent={{-120,-10},{-100,10}})));
equation
  ...
  connect(pipe.Kfr, Kfr) annotation (Line(points={{0,6.53332},{0,20}}, color={0,0,127}));
end Pipe_reverse;
