...
equation
  ...
  connect(steamDryer.C_in, source.C_out) annotation (Line(points={{-32,16},{-32,12},{-65,12}},
                                            color={28,108,200}));
  connect(steamDryer.C_steam_out, steam_sink.C_in) annotation (Line(points={{28,16},{28,12},{61,12}},
                                                  color={28,108,200}));
  connect(steamDryer.C_liquid_out, liquid_sink.C_in) annotation (Line(points={{28,-8},{28,-8},{52,-8},{52,-40},{61,-40}},
                                                      color={28,108,200}));
end SteamDryer;
