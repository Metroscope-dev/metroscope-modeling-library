...
model Tank
  ...
  MetroscopeModelingLibrary.WaterSteam.Volumes.Tank                tank           annotation (Placement(transformation(extent={{-23,-23},{23,23}})));
...
equation
  ...
  connect(tank.C_out, sink.C_in) annotation (Line(points={{23,0},{69.5,0}}, color={28,108,200}));
  connect(tank.C_in, source.C_out) annotation (Line(points={{-23,0},{-70.5,0}}, color={28,108,200}));
end Tank;
