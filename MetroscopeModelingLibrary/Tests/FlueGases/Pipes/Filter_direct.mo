...
equation
  ...
  connect(source.C_out, filter.C_in) annotation (Line(points={{-23,0},{-10,0}}, color={95,95,95}));
  connect(filter.C_out, sink.C_in) annotation (Line(points={{10,0},{23,0}}, color={95,95,95}));
