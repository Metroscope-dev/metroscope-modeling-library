...
model TestCondenserSimple_wIncondensable
  ...
  MetroscopeModelingLibrary.WaterSteam.HeatExchangers.CondenserSimple_wIncondensable
                                                                      condenser
...
equation
  ...
  condenser.Kth = 50000;
  condenser.P_offset=0.002e5;
  condenser.N_incond=5;
  ...
  */
  ...
  connect(turbine_outlet.C_out, condenser.C_hot_in)
    annotation (Line(points={{-10,32},{0,32},{0,10.2}},   color={238,46,47}));
  connect(condenser.C_hot_out, extracted_water.C_in) annotation (Line(points={{0,-10.2},
          {0,-30},{10,-30}},         color={238,46,47}));
  connect(cooling_inlet.C_out, condenser.C_cold_in)
    annotation (Line(points={{-30,0},{-10,0}}, color={238,46,47}));
  connect(condenser.C_cold_out, cooling_outlet.C_in)
    annotation (Line(points={{10,0},{30,0}},color={238,46,47}));
...
end TestCondenserSimple_wIncondensable;
