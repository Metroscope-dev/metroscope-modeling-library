...
model TestControlValve
  ...
  input Modelica.Units.SI.AbsolutePressure P_sink(start = 1e5);
...
equation
  ...
  connect(openingSensor.Opening, controlValve.Opening)
    annotation (Line(points={{13.2,22},{-6,22},{-6,18.2}}, color={0,0,0}));
