...
equation
  ...
  // Reverse causality
  // The flash tank has no parameters, so there is no reverse causality.

  connect(sourcesWater1.C_out, flashTank.C_in) annotation (Line(points={{-74,24},
          {-54,24},{-54,25.65},{-32,25.65}}, color={63,81,181}));
  connect(flashTank.C_vapor_out, sink_steam.C_in) annotation (Line(points={{5.8,
          26},{23.9,26},{23.9,24},{40,24}}, color={63,81,181}));
  connect(flashTank.C_liquid_out, sink_water.C_in) annotation (Line(points={{5.8,
          12.35},{23.9,12.35},{23.9,8},{40,8}}, color={63,81,181}));
