...
equation
  ...
  connect(moist_air_IsoPHFlowModel.C_out, moist_air_Sink.C_in) annotation (Line(points={{51,-0.23},{57.2,-0.23},{57.2,0},{76,0}},     color={28,108,200}));
  ...
  connect(moist_air_IsoPHFlowModel.C_in, moist_air_FlowSensor.C_out) annotation (Line(points={{5,-0.23},{-11.5,-0.23},{-11.5,-0.1},{-18,-0.1}}, color={28,108,200}));
