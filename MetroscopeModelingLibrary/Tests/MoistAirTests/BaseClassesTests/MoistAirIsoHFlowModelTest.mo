...
equation
  ...
  connect(moist_air_IsoHFlowModel.C_out, moist_air_Sink.C_in) annotation (Line(points={{51,0},{57.2,0},{57.2,0},{76,0}},             color={28,108,200}));
  ...
  connect(moist_air_IsoHFlowModel.C_in, moist_air_FlowSensor.C_out) annotation (Line(points={{5,0},{-11.5,0},{-11.5,0},{-18,0}},               color={28,108,200}));
