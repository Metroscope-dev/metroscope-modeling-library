...
package DynamicComponents
  ...
  */
  ...
  package HeatExchangers
    ...
    model MonoPhasicHX_v2_reverse "Added more info on fins and used ESCOA correlation"
     import MetroscopeModelingLibrary.Utilities.Units;
      import MetroscopeModelingLibrary.Utilities.Units.Inputs;
      import MetroscopeModelingLibrary.Utilities.Constants;
      import CorrelationConstants =
    ...
    equation
      ...
      // ------ Tubes configuration parameters ------
        ...
        Pr_fg_s = FlueGasesMedium.specificHeatCapacityCp(state_fg_s)*FlueGasesMedium.dynamicViscosity(state_fg_s)/FlueGasesMedium.thermalConductivity(state_fg_s);
        // Convection coefficient calculation
        Nu_fg_avg = Corr_coeff*K_conv_fg*D_out/k_fg[N+1];
        // Nu_fg_avg = CorrelationConstants.Zukauskas(Re_fg_max, Pr_fg, Pr_fg_s, Tubes_Config, Rows, S_T, S_L);
        Nu_fg_avg =CorrelationConstants.ESCOA(Re_fg_max, Pr_fg, Rows, T_fg_avg, T_wall_avg, D_out, H_fin, e_fin, S_f, S_T, S_L);
  ...
  package Tests
    ...
    model MonoPhasicHX_v2_reverse_test
      import MetroscopeModelingLibrary.Utilities.Units;
      import MetroscopeModelingLibrary.Utilities.Units.Inputs;
      HeatExchangers.MonoPhasicHX_v2_reverse
                                        monoPhasicHX_v2_reverse(
        N_tubes_row=184,
        Rows=2,
        Tubes_Config=2,
        fg_path_width=14.07,                               N=10,
    ...
    equation
      ...
      monoPhasicHX_v2_reverse.Corr_coeff = 1;

      connect(monoPhasicHX_v2_reverse.water_inlet, cold_source.C_out) annotation (Line(points={{10,9.4},{10,8},{48,8},{48,20},{59,20}}, color={28,108,200}));
      connect(monoPhasicHX_v2_reverse.water_outlet, cold_sink.C_in) annotation (Line(points={{-10,9.62},{-10,8},{-48,8},{-48,20},{-59,20}}, color={28,108,200}));
      connect(monoPhasicHX_v2_reverse.fg_inlet, hot_source.C_out) annotation (Line(points={{-10,0.6},{-50,0.6},{-50,-40},{-61,-40}}, color={95,95,95}));
      connect(monoPhasicHX_v2_reverse.fg_outlet, hot_sink.C_in) annotation (Line(points={{9.8,0.6},{50,0.6},{50,-40},{59,-40}}, color={95,95,95}));
      annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(coordinateSystem(preserveAspectRatio=false)),
        experiment(
          StopTime=500,
          __Dymola_NumberOfIntervals=1000,
          __Dymola_Algorithm="Dassl"));
    end MonoPhasicHX_v2_reverse_test;
  end Tests;
  ...
  model Test_Function
    ...
    parameter Real Re_fg_max = 5500;
    parameter Integer Tubes_Config = 1;
    parameter Integer Rows = 20;

    //output Real Nu;

    output Real Constant_C "Constant used in the Zukauskas empirical relation";
    output Real Constant_m "Constant used in the Zukauskas empirical relation";
    //MetroscopeModelingLibrary.DynamicComponents.CorrelationConstants.ExternalFlowConvectionCoefficient HTC(Re_fg_max = Re_fg_max, Tubes_Config = Tubes_Config, Rows = Rows);

  equation
    (Constant_C, Constant_m) =CorrelationConstants.Zukauskas(
        Re_fg_max=Re_fg_max,
