  ...
  package HeatExchangers
    ...
    package One_pass_HX
      ...
      package AssumptionsValidation
        ...
        package DiscAlongTubeLength
          ...
          model AlongZ_discretized_2HX_same_direction
            import MetroscopeModelingLibrary.Utilities.Units;
            import MetroscopeModelingLibrary.Utilities.Units.Inputs;
            HeatExchangers.One_pass_HX.AssumptionsValidation.TubeWallTemperatureDistribution.CrossCurrent_2D_2NodeConduction HX1(
              N_tubes_row=368,
          ...
          equation
            ...
            annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              ...
              experiment(
                ...
                __Dymola_NumberOfIntervals=1000,
                __Dymola_Algorithm="Dassl"));
          end AlongZ_discretized_2HX_same_direction;

          model AlongZ_discretized_2HX_opp_direction
            import MetroscopeModelingLibrary.Utilities.Units;
            import MetroscopeModelingLibrary.Utilities.Units.Inputs;
          ...
          equation
            ...
            annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              ...
              experiment(
                ...
                __Dymola_NumberOfIntervals=1000,
                __Dymola_Algorithm="Dassl"));
          end AlongZ_discretized_2HX_opp_direction;

          model AlongZ_averaged_3HX
            import MetroscopeModelingLibrary.Utilities.Units;
            import MetroscopeModelingLibrary.Utilities.Units.Inputs;
            HeatExchangers.One_pass_HX.AssumptionsValidation.TubeWallTemperatureDistribution.CrossCurrent_2D_2NodeConduction HX1(
              N_tubes_row=368,
            ...
            input Real P_cold_source_HP(start = 121.2, min = 1.5, nominal = 100) "barA";
            input Utilities.Units.MassFlowRate Q_cold_source_HP(start = 84.06) "kg/s";
            input Real T_cold_source_HP(start = 393.5, min = 130, nominal = 150) "degC";
            ...
            WaterSteam.BoundaryConditions.Sink cold_sink_IP annotation (Placement(transformation(
                  ...
                  rotation=270,
                  origin={0,64})));
            TubeWallTemperatureDistribution.CrossCurrent_2D_2NodeConduction                                                  HX3(
              N_tubes_row=368,
              Rows=1,
              Tubes_Config=2,
              fg_path_width=14.07,
              ...
              T_wall_0=745.15,
              K_conv_water=2415.5,
              K_conv_fg=65.56) annotation (Placement(transformation(extent={{30,11},{50,-11}})));
          equation
            hot_source.Xi_out = {0.7481,0.1392,0.0525,0.0601,0.0};
            hot_source.P_out = P_hot_source*1e5;
            hot_source.T_out = T_hot_source + 273.15 + step.y;
            ...
            connect(HX1.water_outlet, cold_sink_HP.C_in) annotation (Line(points={{-40,11},{-40,59}}, color={238,46,47},
                thickness=1,
                pattern=LinePattern.Dash));
            connect(HX2.water_inlet, cold_source_IP.C_out) annotation (Line(points={{0,-11},{0,-45},{9.4369e-16,-45},{9.4369e-16,-79}},
                                                                                                        color={244,125,35},
                thickness=1,
                pattern=LinePattern.Dash));
            ...
            connect(HX3.water_inlet, cold_source_HP.C_out) annotation (Line(points={{40,11},{40,59}}, color={238,46,47},
                thickness=1,
                pattern=LinePattern.Dash));
            connect(HX3.water_outlet, HX1.water_inlet) annotation (Line(points={{40,-11},{40,-40},{-40,-40},{-40,-11}}, color={238,46,47},
                thickness=1,
                pattern=LinePattern.Dash));
            annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                  Ellipse(lineColor={0,140,72},
              ...
              experiment(
                ...
                __Dymola_NumberOfIntervals=1000,
                __Dymola_Algorithm="Dassl"));
          end AlongZ_averaged_3HX;

          model AlongZ_discretized_3HX
            import MetroscopeModelingLibrary.Utilities.Units;
            import MetroscopeModelingLibrary.Utilities.Units.Inputs;
            HeatExchangers.One_pass_HX.AssumptionsValidation.TubeWallTemperatureDistribution.CrossCurrent_2D_2NodeConduction HX1(
              N_tubes_row=368,
            ...
            WaterSteam.BoundaryConditions.Sink cold_sink_IP annotation (Placement(transformation(
                  ...
                  rotation=270,
                  origin={0,64})));
            CrossCurrent_2D_2NodeConduction_List_input                                                                       HX3(
              N_tubes_row=368,
              Rows=1,
              Tubes_Config=2,
              fg_path_width=14.07,
    ...
    package Multiple_pass_HX
      ...
      package AssumptionsValidation
        ...
        model HX_4_pass_ConstantK_disc_fg
          import MetroscopeModelingLibrary.Utilities.Units;
          import MetroscopeModelingLibrary.Utilities.Units.Inputs;
          ...
          One_pass_HX.AssumptionsValidation.DiscAlongTubeLength.CrossCurrent_2D_2NodeConduction_List_input
                                                                                       Dir_1(
            N_tubes_row=N_tubes_row_dir_1,
            D_out = D_out,
        e = e,
        ...
        equation
          ...
          annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
            ...
            experiment(
              ...
              __Dymola_NumberOfIntervals=1000,
              __Dymola_Algorithm="Dassl"));
        end HX_4_pass_ConstantK_disc_fg;
        ...
        model AlongY_1HX
          ...
          input Utilities.Units.MassFlowRate Q_cold_source(start = 84.06) "kg/s";
          input Real T_cold_source(start = 250, min = 130, nominal = 150) "degC";
          ...
          HX_4_pass_ConstantK hX_4_pass_ConstantK(
            N_tubes_row_dir_1=41,
            N_tubes_row_dir_2=41,
            N_tubes_row_dir_3=41,
            N_tubes_row_dir_4=41,
            D_out=38.1e-3,
            e=3.404e-3,
            L=18.29,
            Rows=1,
        ...
        equation
          ...
          connect(hX_4_pass_ConstantK.fg_outlet, hot_sink.C_in) annotation (Line(points={{10,-40},{79,-40}}, color={95,95,95},
              thickness=1));
          connect(hX_4_pass_ConstantK.inlet, cold_source.C_out) annotation (Line(points={{-6,-30},{-6,40},{-79,40}}, color={238,46,47},
              thickness=1));
          connect(hX_4_pass_ConstantK.outlet, cold_sink.C_in) annotation (Line(points={{6,-30},{6,40},{79,40}}, color={238,46,47},
              thickness=1));
          annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                Ellipse(lineColor={0,140,72},
                        fillColor={255,255,255},
        ...
        model AlongY_1HX_1Pass
          ...
          FlueGases.BoundaryConditions.Sink hot_sink annotation (Placement(transformation(extent={{74,-10},{94,10}})));
          Modelica.Blocks.Sources.Step step(height=-20, startTime=100) annotation (Placement(transformation(extent={{-60,60},{-40,80}})));
          One_pass_HX.AssumptionsValidation.TubeWallTemperatureDistribution.CrossCurrent_2D_2NodeConduction crossCurrent_2D_2NodeConduction(
            D_out=0.0381,
            e=0.003404,
            L=18.29,
            N_tubes_row=164,
            ...
            N=10,
            K_conv_water=7832,
            K_conv_fg=61.21) annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
        equation
          hot_source.Xi_out = {0.7481,0.1392,0.0525,0.0601,0.0};
          hot_source.P_out = P_hot_source*1e5;
          hot_source.T_out = T_hot_source + 273.15 + step.y;
          ...
          connect(crossCurrent_2D_2NodeConduction.fg_inlet, hot_source.C_out) annotation (Line(
              points={{-4,0},{-79,0}},
              color={95,95,95},
              thickness=1));
          connect(crossCurrent_2D_2NodeConduction.fg_outlet, hot_sink.C_in) annotation (Line(
              points={{4,0},{79,0}},
              color={95,95,95},
              thickness=1));
          connect(crossCurrent_2D_2NodeConduction.water_outlet, cold_sink.C_in) annotation (Line(
              points={{0,10},{0,79}},
              color={238,46,47},
              thickness=1));
          connect(crossCurrent_2D_2NodeConduction.water_inlet, cold_source.C_out) annotation (Line(
              points={{0,-10},{0,-44.5},{2.77556e-16,-44.5},{2.77556e-16,-79}},
              color={238,46,47},
              thickness=1));
          annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                Ellipse(lineColor={0,140,72},
        ...
        model AlongY_2HX
          ...
          Modelica.Blocks.Sources.Step step(height=-20, startTime=100) annotation (Placement(transformation(extent={{-60,60},{-40,80}})));
          HX_4_pass_ConstantK hX_4_pass_ConstantK(
            N_tubes_row_dir_1=21,
            N_tubes_row_dir_2=21,
            N_tubes_row_dir_3=21,
            N_tubes_row_dir_4=21,
            D_out=38.1e-3,
            e=3.404e-3,
            L=18.29,
            Rows=1,
            ...
            N=10,
            K_conv_water=7832,
            K_conv_fg=61.21) annotation (Placement(transformation(extent={{-40,-50},{-20,-30}})));
          HX_4_pass_ConstantK hX_4_pass_ConstantK1(
            N_tubes_row_dir_1=21,
            N_tubes_row_dir_2=21,
            N_tubes_row_dir_3=21,
            N_tubes_row_dir_4=21,
            ...
            N=10,
            K_conv_water=7832,
            K_conv_fg=61.21) annotation (Placement(transformation(extent={{20,-50},{40,-30}})));
        equation
          hot_source.Xi_out = {0.7481,0.1392,0.0525,0.0601,0.0};
          hot_source.P_out = P_hot_source*1e5;
          hot_source.T_out = T_hot_source + 273.15 + step.y;
          ...
          connect(hot_source.C_out, hX_4_pass_ConstantK.fg_inlet) annotation (Line(points={{-79,-40},{-40,-40}}, color={95,95,95},
              thickness=1));
          connect(hX_4_pass_ConstantK.fg_outlet, hX_4_pass_ConstantK1.fg_inlet) annotation (Line(
              points={{-20,-40},{20,-40}},
              color={95,95,95},
              thickness=1));
          connect(hot_sink.C_in, hX_4_pass_ConstantK1.fg_outlet) annotation (Line(
              points={{79,-40},{40,-40}},
              color={95,95,95},
              thickness=1));
          connect(hX_4_pass_ConstantK1.inlet, cold_source.C_out) annotation (Line(
              points={{24,-30},{24,40},{79,40}},
              color={238,46,47},
              thickness=1,
              arrow={Arrow.Filled,Arrow.None}));
          connect(hX_4_pass_ConstantK1.outlet, hX_4_pass_ConstantK.inlet) annotation (Line(
              points={{36,-30},{36,0},{-36,0},{-36,-30}},
              color={238,46,47},
              thickness=1,
              arrow={Arrow.None,Arrow.Filled}));
          connect(hX_4_pass_ConstantK.outlet, cold_sink.C_in) annotation (Line(
              points={{-24,-30},{-24,40},{-79,40}},
              color={238,46,47},
              thickness=1));
          annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
        ...
        model AlongY_2HX_Disc_same_dir
          import MetroscopeModelingLibrary.Utilities.Units;
          import MetroscopeModelingLibrary.Utilities.Units.Inputs;
        ...
        equation
          ...
          hX_4_pass_ConstantK_disc_fg.Dir_1.h_fg[1,  :] = hX_4_pass_ConstantK.Dir_1.h_fg[hX_4_pass_ConstantK.Dir_1.Rows + 1, :];
          hX_4_pass_ConstantK_disc_fg.Dir_2.h_fg[1,  :] = hX_4_pass_ConstantK.Dir_2.h_fg[hX_4_pass_ConstantK.Dir_2.Rows + 1, :];
          hX_4_pass_ConstantK_disc_fg.Dir_3.h_fg[1,  :] = hX_4_pass_ConstantK.Dir_3.h_fg[hX_4_pass_ConstantK.Dir_3.Rows + 1, :];
          hX_4_pass_ConstantK_disc_fg.Dir_4.h_fg[1,  :] = hX_4_pass_ConstantK.Dir_4.h_fg[hX_4_pass_ConstantK.Dir_4.Rows + 1, :];

          connect(hot_source.C_out, hX_4_pass_ConstantK.fg_inlet) annotation (Line(points={{-79,-40},{-40,-40}}, color={95,95,95},
              thickness=1));
          connect(hX_4_pass_ConstantK.fg_outlet, hX_4_pass_ConstantK_disc_fg.fg_inlet) annotation (Line(points={{-20,-40},{20,-40}}, color={95,95,95},
              thickness=1));
          connect(hot_sink.C_in, hX_4_pass_ConstantK_disc_fg.fg_outlet) annotation (Line(points={{79,-40},{40,-40}}, color={95,95,95},
              thickness=1));
          connect(hX_4_pass_ConstantK_disc_fg.inlet, cold_source.C_out) annotation (Line(
              points={{24,-30},{24,40},{79,40}},
              color={238,46,47},
              thickness=1,
              arrow={Arrow.Filled,Arrow.None}));
          connect(hX_4_pass_ConstantK_disc_fg.outlet, hX_4_pass_ConstantK.inlet) annotation (Line(
              points={{36,-30},{36,0},{-36,0},{-36,-30}},
              color={238,46,47},
              thickness=1,
              arrow={Arrow.None,Arrow.Filled}));
          ...
          annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
            ...
            experiment(
              ...
              __Dymola_NumberOfIntervals=1000,
              __Dymola_Algorithm="Dassl"));
        end AlongY_2HX_Disc_same_dir;

        model AlongY_2HX_Disc_opp_dir
          import MetroscopeModelingLibrary.Utilities.Units;
          import MetroscopeModelingLibrary.Utilities.Units.Inputs;
        ...
        equation
          ...
          hX_4_pass_ConstantK_disc_fg.Dir_1.h_fg[1,  :] = Modelica.Math.Vectors.reverse(hX_4_pass_ConstantK.Dir_1.h_fg[hX_4_pass_ConstantK.Dir_1.Rows + 1, :]);
          hX_4_pass_ConstantK_disc_fg.Dir_2.h_fg[1,  :] = Modelica.Math.Vectors.reverse(hX_4_pass_ConstantK.Dir_2.h_fg[hX_4_pass_ConstantK.Dir_2.Rows + 1, :]);
          hX_4_pass_ConstantK_disc_fg.Dir_3.h_fg[1,  :] = Modelica.Math.Vectors.reverse(hX_4_pass_ConstantK.Dir_3.h_fg[hX_4_pass_ConstantK.Dir_3.Rows + 1, :]);
          hX_4_pass_ConstantK_disc_fg.Dir_4.h_fg[1,  :] = Modelica.Math.Vectors.reverse(hX_4_pass_ConstantK.Dir_4.h_fg[hX_4_pass_ConstantK.Dir_4.Rows + 1, :]);
