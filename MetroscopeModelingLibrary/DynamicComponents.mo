...
package DynamicComponents
  package Constants
    ...
    final constant Real Correction_Factor_C2[2,2] = {{1, 2}, {6, 9}};
  end Constants;
  ...
  package HeatExchangers
    ...
    model MonoPhasicHX_ConvHTC_FGCalc
      ...
      // ------ Geometry ------
        ...
        parameter Integer Rows = 2 "Number of tubes rows";
        parameter Integer N_tubes = N_tubes_row*Rows "Total number of tubes";
        parameter Integer Tubes_Config = 1 "1: aligned, 2: staggered";
      ...
      // ------ Tubes configuration parameters ------
        ...
        Real Pr_fg "Water overall average Prandtl number";
    ...
    equation
      ...
      // ------ Tubes configuration parameters ------
        ...
        Re_fg_max = rho_fg[1]*U_fg_max*D_out/Mu_fg[1];
        // Flue gas Prandtl number
        Pr_fg = Cp_fg[1]*Mu_fg[1]/k_fg[1];
