...
package DynamicComponents
  ...
  */
  ...
  package HeatExchangers
    ...
    model CounterCurrent_MonoPhasicHX_1DConduction "Added more info on fins and used ESCOA correlation"
     import MetroscopeModelingLibrary.Utilities.Units;
      import MetroscopeModelingLibrary.Utilities.Units.Inputs;
      import MetroscopeModelingLibrary.Utilities.Constants;
      import CorrelationConstants =
    ...
    equation
      ...
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
            ...
            Text(
              ...
              fontSize=20,
              textString="Flue gas side")}),                         Diagram(coordinateSystem(preserveAspectRatio=false)));
    end CounterCurrent_MonoPhasicHX_1DConduction;
    ...
    model CrossCurrent_MonoPhasicHX_1DConduction "Added more info on fins and used ESCOA correlation"
     import MetroscopeModelingLibrary.Utilities.Units;
      import MetroscopeModelingLibrary.Utilities.Units.Inputs;
      import MetroscopeModelingLibrary.Utilities.Constants;
      import CorrelationConstants =
    ...
    equation
      ...
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
            ...
            Line(points={{-40,20},{40,20}},  color={0,0,0}),
            Line(points={{-40,0},{40,0}},    color={0,0,0})}),       Diagram(coordinateSystem(preserveAspectRatio=false)));
    end CrossCurrent_MonoPhasicHX_1DConduction;
  end HeatExchangers;
  ...
  package Tests
    ...
    model MonoPhasicHX_LCM_Test
      import MetroscopeModelingLibrary.Utilities.Units;
      import MetroscopeModelingLibrary.Utilities.Units.Inputs;
      HeatExchangers.CounterCurrent_MonoPhasicHX_LCM monoPhasicHX_LCM_1_1(
        N_tubes_row=184,
        Rows=2,
        Tubes_Config=2,
        fg_path_width=14.07,
    ...
    model MonoPhasicHX_2NodesConduction_Test
      import MetroscopeModelingLibrary.Utilities.Units;
      import MetroscopeModelingLibrary.Utilities.Units.Inputs;
      HeatExchangers.CounterCurrent_MonoPhasicHX_2NodesConduction monoPhasicHX_2NodesConduction(
        N_tubes_row=184,
        Rows=2,
        K_cond_wall=27,
        Tubes_Config=2,
    ...
    model MonoPhasicHX_1DConduction_Test
      import MetroscopeModelingLibrary.Utilities.Units;
      import MetroscopeModelingLibrary.Utilities.Units.Inputs;
      HeatExchangers.CounterCurrent_MonoPhasicHX_1DConduction monoPhasicHX_1D_ter(
        N_tubes_row=184,
        Rows=2,
        Tubes_Config=2,
        fg_path_width=14.07,
    ...
    model MonoPhasicHX_1DConduction_plate_Test
      import MetroscopeModelingLibrary.Utilities.Units;
      import MetroscopeModelingLibrary.Utilities.Units.Inputs;
      HeatExchangers.CounterCurrent_MonoPhasicHX_1DConduction_plate monoPhasicHX_1D_ter(
        N_tubes_row=184,
        Rows=2,
        Tubes_Config=2,
        fg_path_width=14.07,
    ...
    equation
      ...
      annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(coordinateSystem(preserveAspectRatio=false)),
        experiment(
          ...
          __Dymola_NumberOfIntervals=1000,
          __Dymola_Algorithm="Dassl"));
    end MonoPhasicHX_1DConduction_plate_Test;
    ...
    model CrossCurrent_MonoPhasicHX_1DConduction_Test
      ...
      Modelica.Blocks.Sources.Ramp ramp(
        ...
        duration=60,
        startTime=300) annotation (Placement(transformation(extent={{58,70},{78,90}})));
      HeatExchangers.CrossCurrent_MonoPhasicHX_1DConduction crossCurrent_MonoPhasicHX_LCM(
        D_out=0.0381,
        e=0.003048,
        L=18.29,
        N_tubes_row=184,
