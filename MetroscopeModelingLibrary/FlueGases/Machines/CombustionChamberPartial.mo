...
partial model CombustionChamberPartial
   package FuelMedium =
  ...
  InputPower Wfuel(start=800e6);
  Modelica.Units.SI.SpecificEnergy LHV_int(start=48130e3) "Internal variable for LHV";
