...
model GT_louvers
  ...
  FlueGases.Connectors.Outlet C_out annotation (Placement(transformation(extent={{92,-10},{112,10}}), iconTransformation(extent={{50,-10},{70,10}})));
  ...
  MultiFluid.Converters.MoistAir_to_FlueGases moistAir_to_FlueGases annotation (Placement(transformation(extent={{62,-10},{82,10}})));
equation
  ...
  connect(relativeHumiditySensor.C_out, moistAir_to_FlueGases.inlet) annotation (Line(points={{50,0},{62,0}}, color={85,170,255}));
  connect(C_out, C_out) annotation (Line(points={{102,0},{102,0}}, color={95,95,95}));
  connect(C_out, moistAir_to_FlueGases.outlet) annotation (Line(points={{102,0},{82,0}}, color={95,95,95}));
