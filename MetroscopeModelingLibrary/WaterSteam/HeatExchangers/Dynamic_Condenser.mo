...
model Dynamic_Condenser
  ...
  parameter Boolean steady_state = false "true: sets the time derivatives to zero" annotation(Dialog(tab="General", group="Modes"));
  // Design and geometry parameters
  parameter Real r_UA = 3 "Ratio of heat conductances between water and fg" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Units.Mass M_wall = 25379 "Tubes total mass" annotation(Dialog(tab="General", group="Design and geometry"));
  parameter Units.HeatCapacity Cp_wall = 420 "Tubes specific heat capacity" annotation(Dialog(tab="General", group="Design and geometry"));
  ...
  // Initialization
  parameter Units.Temperature T_wall_0 = 450 "Wall temperature" annotation(Dialog(tab="General", group="Initialization"));
  ...
  parameter Units.PositiveMassFlowRate Q_fg_0 = 640 "Fg mass flow rate" annotation(Dialog(tab="General", group="Initialization"));
  parameter Units.Temperature T_water_out_0 = 500 "Water outlet temperature" annotation(Dialog(tab="General", group="Initialization"));
  parameter Units.Temperature T_fg_out_0 = 560 "Fg outlet temperature" annotation(Dialog(tab="General", group="Initialization"));
  ...
  WaterSteam.Pipes.HeatLoss cold_side annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-30,20})));
  Utilities.Interfaces.GenericReal UA annotation (Placement(transformation(
        extent={{-4,-4},{4,4}},
        rotation=180,
        ...
        rotation=180,
        origin={-100,40})));
  Utilities.Interfaces.GenericReal Qv_cold annotation (Placement(transformation(
        extent={{-4,-4},{4,4}},
        rotation=180,
