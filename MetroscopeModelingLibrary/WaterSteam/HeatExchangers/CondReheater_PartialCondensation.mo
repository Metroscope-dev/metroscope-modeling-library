...
model CondReheater_PartialCondensation
  ...
  replaceable MetroscopeModelingLibrary.Common.Partial.IsoPFlowModel deheating_hot(Q_0=Q_hot_0, use_homotopy=use_homotopy, redeclare package Medium = HotMedium)
    annotation (Placement(transformation(extent={{-52,28},{2,52}})));
  replaceable Common.Partial.IsoPFlowModel deheating_cold(Q_0=Q_cold_0, use_homotopy=use_homotopy, redeclare package Medium = ColdMedium)
