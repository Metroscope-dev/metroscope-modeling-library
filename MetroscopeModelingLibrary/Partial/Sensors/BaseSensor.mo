...
partial model BaseSensor
  ...
  replaceable BaseClasses.IsoPHFlowModel isoPHFlowModel annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
equation
  ...
  connect(isoPHFlowModel.C_in, C_in) annotation (Line(points={{-10,0},{-100,0}}, color={95,95,95}));
  connect(isoPHFlowModel.C_out, C_out) annotation (Line(points={{10,0},{100,0}}, color={0,0,0}));
