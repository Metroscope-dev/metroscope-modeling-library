...
model CombustionChamber_REF
  ...
  BoundaryConditions.Sink sink_RefMoistAir annotation (Placement(transformation(extent={{-32,-10},{-12,10}})));
  Connectors.Inlet inlet annotation (Placement(transformation(extent={{-100,-10},{-80,10}})));
equation
  ...
  connect(sink_RefMoistAir.C_in, inlet) annotation (Line(points={{-27,0},{-90,0}}, color={0,255,128}));
  annotation (
