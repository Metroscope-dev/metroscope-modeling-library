...
equation
  ...
  connect(flashTank.C_out_steam, cold_steam_sink.C_in) annotation (Line(points={
          {16,69.8},{16,68},{48,68},{48,80},{59,80}}, color={28,108,200}));
  connect(cold_liquid_sink.C_in,flashTank.C_out_liquid)
    annotation (Line(points={{59,48},{16,48},{16,56.2}}, color={28,108,200}));
  connect(flashTank.C_out_liquid, evaporator.C_cold_in) annotation (Line(points=
