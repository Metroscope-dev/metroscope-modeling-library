...
model MetroscopiaCCGT_causality_reverse
  ...
  // Parameters
    ...
    // Gas Turbine
  parameter MetroscopeModelingLibrary.Utilities.Units.SpecificEnthalpy GT_h_out=1e6;
                                                                               // This enthalpy corresponds to T = 640°C at 1.1 bar
  ...
  // Calibrated parameters (input used for calibration in comment)
    ...
    // Gas Turbine
  output MetroscopeModelingLibrary.Utilities.Units.FrictionCoefficient Filter_Kfr;
    ...
    // Economizer
  output MetroscopeModelingLibrary.Utilities.Units.HeatExchangeCoefficient Eco_Kth;
                                                                            // Economizer water outlet temperature
  output MetroscopeModelingLibrary.Utilities.Units.FrictionCoefficient Eco_Kfr_hot;
                                                                            // Gas turbine outlet pressure
  output MetroscopeModelingLibrary.Utilities.Units.FrictionCoefficient Eco_Kfr_cold;
                                                                             // Economizer water outlet pressure
    // Evaporator
  output MetroscopeModelingLibrary.Utilities.Units.Cv Evap_CV_Cvmax;
                                                             // Evaporator control valve opening
  output MetroscopeModelingLibrary.Utilities.Units.HeatExchangeCoefficient Evap_Kth;
                                                                             // Extraction pump mass flow rate
    // High Pressure Superheater 1
  output MetroscopeModelingLibrary.Utilities.Units.HeatExchangeCoefficient HPSH1_Kth;
                                                                              // HP superheater outlet temperature
  output MetroscopeModelingLibrary.Utilities.Units.FrictionCoefficient HPSH1_Kfr_cold;
                                                                               // HP superheater inlet pressure
    // High Pressure Superheater 2
  output MetroscopeModelingLibrary.Utilities.Units.HeatExchangeCoefficient HPSH2_Kth;
                                                                              // De-superheater mass flow rate
  output MetroscopeModelingLibrary.Utilities.Units.FrictionCoefficient HPSH2_Kfr_cold;
                                                                               // HP superheater inlet pressure
    // De-superheater
  output MetroscopeModelingLibrary.Utilities.Units.Cv deSH_CV_Cvmax;
                                                             // Desuperheater control valve opening
    // Reheater
  output MetroscopeModelingLibrary.Utilities.Units.HeatExchangeCoefficient ReH_Kth;
                                                                            // LP superheater outlet temperature
  output MetroscopeModelingLibrary.Utilities.Units.FrictionCoefficient ReH_Kfr_cold;
                                                                             // LP superheater inlet pressure
    // High Pressure Steam Turbine
  output MetroscopeModelingLibrary.Utilities.Units.Cv HPST_CV_Cv;
                                                          // HP superheater outlet pressure
  output MetroscopeModelingLibrary.Utilities.Units.Cst HPST_Cst;
                                                         // HP steam turbine inlet pressure
  output MetroscopeModelingLibrary.Utilities.Units.Yield HPST_eta_is;
                                                              // HP steam turbine outlet temperature
  output MetroscopeModelingLibrary.Utilities.Units.Yield LPST_eta_is;
                                                              // Power output
    // Low Pressure Steam Turbine
  output MetroscopeModelingLibrary.Utilities.Units.Cv LPST_CV_Cv;
                                                          // Low pressure superheater outlet pressure
  output MetroscopeModelingLibrary.Utilities.Units.Cst LPST_Cst;
                                                         // LP steam turbine inlet pressure
    // Condenser
  output MetroscopeModelingLibrary.Utilities.Units.HeatExchangeCoefficient Cond_Kth;
                                                                             // Condensation pressure
  output MetroscopeModelingLibrary.Utilities.Units.VolumeFlowRate Qv_cond_cold;
  ...
  output MetroscopeModelingLibrary.Utilities.Units.Cv pumpRec_CV_Cvmax;
                                                                // Recirculation control valve opening

    // Observables of interest

  output MetroscopeModelingLibrary.Utilities.Units.PositiveMassFlowRate Q_fuel_source;
                                                                               // Observable: controlled by the gas turbine outlet temperature
