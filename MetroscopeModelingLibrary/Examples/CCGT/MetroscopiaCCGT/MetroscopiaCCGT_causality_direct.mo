...
model MetroscopiaCCGT_causality_direct
  ...
  // Observables
    ...
    output MetroscopeModelingLibrary.Utilities.Units.MassFlowRate Q_fuel_source; // Controlled by the gas turbine outlet temperature 10.5
  ...
  // Calibrated parameters (input used for calibration in comment)
    ...
    // Gas Turbine
    parameter MetroscopeModelingLibrary.Utilities.Units.FrictionCoefficient Filter_Kfr=0.04432005; // Filter outlet pressure
    ...
    // Economizer
    parameter MetroscopeModelingLibrary.Utilities.Units.HeatExchangeCoefficient Eco_Kth=3104.9373; // Economizer water outlet temperature
    parameter MetroscopeModelingLibrary.Utilities.Units.FrictionCoefficient Eco_Kfr_hot=0.022388678; // Gas turbine outlet pressure
    parameter MetroscopeModelingLibrary.Utilities.Units.FrictionCoefficient Eco_Kfr_cold=973146.4; // Economizer water outlet pressure
    // Evaporator
    parameter MetroscopeModelingLibrary.Utilities.Units.Cv Evap_CV_Cvmax=539.1173; // Evaporator control valve opening
    parameter MetroscopeModelingLibrary.Utilities.Units.HeatExchangeCoefficient Evap_Kth=3383.7917; // Extraction pump mass flow rate
    // High Pressure Superheater 1
    parameter MetroscopeModelingLibrary.Utilities.Units.HeatExchangeCoefficient HPSH1_Kth=1213.6362; // HP superheater outlet temperature
    parameter MetroscopeModelingLibrary.Utilities.Units.FrictionCoefficient HPSH1_Kfr_cold=7030.31; // HP superheater inlet pressure
    // High Pressure Superheater 2
    parameter MetroscopeModelingLibrary.Utilities.Units.HeatExchangeCoefficient HPSH2_Kth=1673.8336; // De-superheater mass flow rate
    parameter MetroscopeModelingLibrary.Utilities.Units.FrictionCoefficient HPSH2_Kfr_cold=2538.3271; // HP superheater inlet pressure
    // De-superheater
    parameter MetroscopeModelingLibrary.Utilities.Units.Cv deSH_CV_Cvmax=7.7502966; // Desuperheater control valve opening
    // Reheater
    parameter MetroscopeModelingLibrary.Utilities.Units.HeatExchangeCoefficient ReH_Kth=410.44293; // LP superheater outlet temperature
    parameter MetroscopeModelingLibrary.Utilities.Units.FrictionCoefficient ReH_Kfr_cold=134.2858; // LP superheater inlet pressure
    // High Pressure Steam Turbine
    parameter MetroscopeModelingLibrary.Utilities.Units.Cv HPST_CV_Cv=6647.2905; // HP superheater outlet pressure
    parameter MetroscopeModelingLibrary.Utilities.Units.Cst HPST_Cst=6.038082e+07; // HP steam turbine inlet pressure
    parameter MetroscopeModelingLibrary.Utilities.Units.Yield HPST_eta_is=0.8438316; // HP steam turbine outlet temperature
    parameter MetroscopeModelingLibrary.Utilities.Units.Yield LPST_eta_is=0.8438316; // Power output
    // Low Pressure Steam Turbine
    parameter MetroscopeModelingLibrary.Utilities.Units.Cv LPST_CV_Cv=69310.586; // Low pressure superheater outlet pressure
    parameter MetroscopeModelingLibrary.Utilities.Units.Cst LPST_Cst=411424.22; // LP steam turbine inlet pressure
    // Condenser
    parameter MetroscopeModelingLibrary.Utilities.Units.HeatExchangeCoefficient Cond_Kth=93661.23; // Condensation pressure
    parameter MetroscopeModelingLibrary.Utilities.Units.VolumeFlowRate Qv_cond_cold=2.7349906; // Circulating water outlet temperature
    // Exctraction Pump
