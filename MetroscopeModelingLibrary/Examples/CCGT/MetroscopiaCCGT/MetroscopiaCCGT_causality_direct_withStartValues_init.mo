...
model MetroscopiaCCGT_causality_direct_withStartValues_init
  extends MetroscopiaCCGT_causality_direct_init(
    AirFilter(
      C_in(
        P(start=100000.0),
        Q(start=500.0),
...
end MetroscopiaCCGT_causality_direct_withStartValues_init;
