...
model airCompressor_splitted_moistAir_flueGas_direct
  ...
  parameter Real compression_rate = 20;
  parameter Real eta_is = 0.7108232;
  output Real compression_rate_1; // Hypothesis
...
end airCompressor_splitted_moistAir_flueGas_direct;
