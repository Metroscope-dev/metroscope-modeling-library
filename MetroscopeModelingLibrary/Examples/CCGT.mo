...
package CCGT
  package MetroscopiaCCGT
    ...
    model MetroscopiaCCGT_reverse
      ...
      FlueGases.BoundaryConditions.Source source_air( h_out(start=0.3e6)) annotation (Placement(transformation(extent={{-604,
                -36},{-584,-16}})));
      ...
      Sensors.FlueGases.PressureSensor P_source_air_sensor
        annotation (Placement(transformation(extent={{-582,-32},{-570,-20}})));
      Sensors.FlueGases.TemperatureSensor T_source_air_sensor
        annotation (Placement(transformation(extent={{-564,-32},{-552,-20}})));
      Sensors.FlueGases.FlowSensor Q_source_air_sensor
        annotation (Placement(transformation(extent={{-546,-32},{-534,-20}})));
    ...
    equation
      ...
      connect(source_air.C_out, P_source_air_sensor.C_in)
        annotation (Line(points={{-589,-26},{-582,-26}}, color={95,95,95}));
      connect(P_source_air_sensor.C_out, T_source_air_sensor.C_in)
        annotation (Line(points={{-570,-26},{-564,-26}}, color={95,95,95}));
      connect(T_source_air_sensor.C_out, Q_source_air_sensor.C_in)
        annotation (Line(points={{-552,-26},{-546,-26}}, color={95,95,95}));
      connect(airCompressor.C_in, Q_source_air_sensor.C_out)
        annotation (Line(points={{-524,-26},{-534,-26}}, color={95,95,95}));
      ...
      annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-620,-100},
                {200,240}})),                                     Diagram(
            coordinateSystem(preserveAspectRatio=false, extent={{-620,-100},{200,240}}),
            graphics={Rectangle(
