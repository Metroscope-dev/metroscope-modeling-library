...
model ReheaterLine_reverse
  ...
  parameter Units.Cv valves_cvmax = 8000;
  parameter Units.Percentage valves_opening = 50 "%";
  ...
  input Real reheaters_T_cold_out(start=200);
  ...
  WaterSteam.BoundaryConditions.Source main_steam_source_2 annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-80,146})));
  Sensors.WaterSteam.TemperatureSensor reheaters_T_cold_out_sensor annotation (Placement(transformation(extent={{-138,-10},{-158,10}})));
  ...
  Sensors.Outline.OpeningSensor reheater_2B_drains_valve_opening_sensor annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-31,-87})));
  WaterSteam.Pipes.ControlValve reheater_1B_drains_valve annotation (Placement(transformation(extent={{86,-114},{96,-102}})));
...
equation
  ...
  reheater_1B.Q_cold = reheater_2B.Q_cold;
  // Reheaters 1
    // Boundary conditions
    ...
    reheater_1A_drains_valve.Cvmax = valves_cvmax;
    //reheater_1A_drains_valve_opening_sensor.Opening_pc = valves_opening;
    ...
    reheater_1B_drains_valve.Cvmax = valves_cvmax;
    //reheater_1B_drains_valve_opening_sensor.Opening_pc = valves_opening;
  ...
  // Reheaters 2
    ...
    reheater_2A_drains_valve.Cvmax = valves_cvmax;
    //reheater_2A_drains_valve_opening_sensor.Opening_pc = valves_opening;
    ...
    reheater_2B_drains_valve.Cvmax = valves_cvmax;
    //reheater_2B_drains_valve_opening_sensor.Opening_pc = valves_opening;
  ...
  connect(reheater_2A_drains_valve.C_out, reheater_1A.C_hot_in) annotation (Line(points={{-26,20.1818},{-6,20.1818},{-6,20},{40,20},{40,82},{60,82},{60,68}}, color={217,67,180}));
  ...
  connect(reheater_1B.C_cold_in,reheater_1A. C_cold_in) annotation (Line(
      ...
      color={28,108,200}));
  connect(reheater_2B.C_cold_out, reheaters_T_cold_out_sensor.C_in) annotation (Line(points={{-76,-60},{-119,-60},{-119,0},{-138,0}},             color={28,108,200}));
  connect(reheaters_T_cold_out_sensor.C_out, sink.C_in) annotation (Line(points={{-158,0},{-172.5,0},{-172.5,-1.11022e-15},{-177,-1.11022e-15}}, color={28,108,200}));
  connect(reheater_2A.C_cold_out, reheaters_T_cold_out_sensor.C_in) annotation (Line(points={{-76,60},{-120,60},{-120,0},{-138,0}},             color={28,108,200}));
  ...
  connect(reheater_1B_drains_valve.Opening, reheater_1B_drains_valve_opening_sensor.Opening) annotation (Line(points={{91,-103.091},{91,-92.1}}, color={0,0,127}));
  connect(reheater_1B_drains_valve.C_in, reheater_1B_drains_T_sensor.C_out) annotation (Line(points={{86,-111.818},{86,-112},{60,-112},{60,-100}}, color={217,67,180}));
  connect(reheater_1B_drains_valve.C_out, drains_sink_P_sensor.C_in) annotation (Line(points={{96,-111.818},{96,-112},{136,-112}}, color={28,108,200}));
  connect(reheater_1A_drains_valve.C_out, drains_sink_P_sensor.C_in) annotation (Line(points={{96,20.1818},{104,20.1818},{104,-112},{136,-112}}, color={217,67,180}));
  connect(drains_sink_P_sensor.C_out, drains_sink.C_in) annotation (Line(points={{156,-112},{185,-112}}, color={28,108,200}));
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-220,-160},{220,160}})), Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-220,-160},{220,160}})));
