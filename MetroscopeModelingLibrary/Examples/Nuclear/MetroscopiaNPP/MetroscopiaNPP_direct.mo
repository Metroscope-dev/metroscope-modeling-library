...
equation
  ...
  connect(HP_extract.alpha, HP_extract_alpha.y) annotation (Line(points={{-34.8,69},{-34.8,64},{-22,64},{-22,62},{-24,62},{-24,67}}, color={0,0,127}));
  connect(LP_extract.alpha, LP_extract_alpha.y) annotation (Line(points={{201.2,127},{214,127},{214,126},{212,126},{212,113},{224,113}}, color={0,0,127}));
