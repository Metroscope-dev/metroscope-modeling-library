...
model MetroscopiaNPP_reverse
  ...
  Sensors.WaterSteam.FlowSensor steam_generator_Q_in_sensor annotation (Placement(transformation(extent={{-100,-77},{-114,-63}})));
    // HP Control Valve
  ...
  Sensors.Outline.OpeningSensor HP_control_valve_opening_sensor annotation (Placement(transformation(extent={{-136,86},{-126,96}})));
    // HP Turbines
  Sensors.WaterSteam.PressureSensor HP_turbine_1_P_in_sensor annotation (Placement(transformation(extent={{-106,66.1818},{-94,78.1818}})));
  ...
  Sensors.WaterSteam.PressureSensor HP_turbines_ext_P_sensor annotation (Placement(transformation(
        extent={{-7,-7},{7,7}},
        rotation=270,
        origin={-36,53})));
  Sensors.WaterSteam.PressureSensor HP_turbine_2_P_out_sensor annotation (Placement(transformation(extent={{20,66.1818},{32,78.1818}})));
    // Steam Dryer
  ...
  Sensors.WaterSteam.PressureSensor superheater_drains_P_out_sensor annotation (Placement(transformation(extent={{100,106},{112,118}})));
  Sensors.WaterSteam.TemperatureSensor superheated_steam_T_out_sensor annotation (Placement(transformation(extent={{88,124},{100,136}})));
  ...
  Sensors.WaterSteam.PressureSensor superheater_hot_P_in_sensor annotation (Placement(transformation(extent={{-106,106.182},{-94,118.182}})));
  ...
  Sensors.WaterSteam.PressureSensor LP_turbines_ext_P_sensor annotation (Placement(transformation(
        extent={{-7,-7},{7,7}},
        rotation=270,
        origin={196,111})));
    ...
    // Condenser
  Sensors.WaterSteam.PressureSensor condenser_P_in_sensor annotation (Placement(transformation(extent={{286,124},{298,136}})));
  ...
  Sensors.WaterSteam.PressureSensor cold_sink_P_in_sensor annotation (Placement(transformation(extent={{418,57.7778},{430,69.7778}})));
    WaterSteam.BoundaryConditions.Source cold_source annotation (Placement(transformation(extent={{328,59.7778},{348,79.7778}})));
  Sensors.WaterSteam.FlowSensor cold_source_Qv_out_sensor annotation (Placement(transformation(extent={{352,62.7778},{366,76.7778}})));
    // Extraction Pump
  ...
  Sensors.WaterSteam.TemperatureSensor LP_pump_T_out_sensor annotation (Placement(transformation(extent={{350,-77},{336,-63}})));
  Sensors.WaterSteam.PressureSensor LP_pump_P_out_sensor annotation (Placement(transformation(extent={{7,-7},{-7,7}}, origin={315,-70})));
    // LP reheater
    WaterSteam.HeatExchangers.DryReheater LP_reheater annotation (Placement(transformation(extent={{284,-78},{252,-62}})));
  Sensors.WaterSteam.TemperatureSensor LP_reheater_T_cold_out_sensor annotation (Placement(transformation(extent={{220,-77},{206,-63}})));
  Sensors.WaterSteam.PressureSensor LP_reheater_P_cold_out_sensor annotation (Placement(transformation(extent={{242,-77},{228,-63}})));
  ...
  Sensors.WaterSteam.PressureSensor LP_reheater_drains_control_valve_P_out_sensor annotation (Placement(transformation(extent={{306,-125.818},{318,-113.818}})));
  ...
  Sensors.WaterSteam.TemperatureSensor HP_pump_T_out_sensor annotation (Placement(transformation(extent={{36,-77},{22,-63}})));
  Sensors.WaterSteam.PressureSensor HP_pump_P_out_sensor annotation (Placement(transformation(extent={{7,-7},{-7,7}}, origin={1,-70})));
    // HP Reheater
  ...
  Sensors.WaterSteam.TemperatureSensor HP_reheater_T_cold_out_sensor annotation (Placement(transformation(extent={{-80,-77},{-94,-63}})));
  Sensors.WaterSteam.PressureSensor HP_reheater_P_cold_out_sensor annotation (Placement(transformation(extent={{-60,-77},{-74,-63}})));
  Sensors.WaterSteam.TemperatureSensor HP_reheater_T_drains_sensor annotation (Placement(transformation(
        extent={{7,-7},{-7,7}},
        rotation=90,
        origin={-36,-98})));
  ...
  Sensors.WaterSteam.PressureSensor HP_reheater_drains_control_valve_P_out_sensor annotation (Placement(transformation(extent={{24,-127.818},{36,-115.818}})));
