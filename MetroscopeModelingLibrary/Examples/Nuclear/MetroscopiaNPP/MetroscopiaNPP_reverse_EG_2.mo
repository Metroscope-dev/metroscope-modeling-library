...
model MetroscopiaNPP_reverse_EG_2
  ...
  Utilities.Interfaces.RealOutput LP_heater_Kth annotation (Placement(
    ...
    h_0=640e3)                                                                               annotation (Placement(transformation(extent={{-145,
            -102.182},{-135,-90.182}})));
  Sensors_Control.Outline.OpeningSensor                   LP_reheater_drains_control_valve_opening_sensor annotation (Placement(transformation(extent={{-145,
            -87},{-135,-77}})));
  Utilities.Interfaces.RealInput LP_reheater_drains_control_valve_opening(start=
  ...
  Utilities.Interfaces.RealInput HP_pump_T_out(start=80) annotation (Placement(
    ...
    h_hot_out_0=379e3)                                                                                annotation (Placement(transformation(extent={{-544,
            -68},{-576,-52}})));
    WaterSteam.BoundaryConditions.Sink                           rh_hot_out
                                                                           annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={-560,-94})));
...
equation
  ...
  connect(HP_heater.C_hot_out, rh_hot_out.C_in)
    annotation (Line(points={{-560,-68},{-560,-89}}, color={28,108,200}));
...
end MetroscopiaNPP_reverse_EG_2;
