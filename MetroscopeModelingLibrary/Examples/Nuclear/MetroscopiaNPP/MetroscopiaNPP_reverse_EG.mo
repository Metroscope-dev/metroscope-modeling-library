...
model MetroscopiaNPP_reverse_EG
  ...
  Utilities.Interfaces.RealExpression    deaerator_inlet_pipe_delta_z(y=5)
    annotation (Placement(transformation(extent={{-400,-56},{-380,-36}})));
  ...
  Utilities.Interfaces.RealExpression    deaerator_outlet_pipe_delta_z(y=-5)
    annotation (Placement(transformation(extent={{-466,-56},{-446,-36}})));
  ...
  Utilities.Interfaces.RealOutput HP_heater_Kth_cond annotation (Placement(
        ...
        extent={{-4,-4},{4,4}},
        rotation=270,
        origin={-662,-68}), iconTransformation(extent={{-174,14},{-154,34}})));
...
equation
  ...
  connect(deaerator_inlet_pipe_delta_z.y, deaerator_inlet_pipe.delta_z)
    annotation (Line(points={{-390,-50},{-390,-55.2}},          color={0,0,127}));
  ...
  connect(deaerator_outlet_pipe_delta_z.y, deaerator_outlet_pipe.delta_z)
    annotation (Line(points={{-456,-50},{-456,-55.2}},          color={0,0,127}));
  ...
  connect(HP_heater.Kth_cond, HP_heater_Kth_cond)
    annotation (Line(points={{-646,-70},{-646,-74},{-662,-74},{-662,-68}},
                                                     color={0,0,127}));
