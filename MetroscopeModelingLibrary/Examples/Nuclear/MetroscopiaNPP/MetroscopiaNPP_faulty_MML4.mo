...
model MetroscopiaNPP_faulty_MML4

  extends MetroscopiaNPP_direct_MML4(
...
equation
  ...
  connect(bypass_HP_turbine_to_condenser.C_out, condenser.C_hot_in) annotation (Line(points={{-113,42},
          {-113,32},{320,32},{320,100},{20,100},{20,34.6074}},                                                                                           color={217,67,180}));
  connect(bypass_LP_turbine_to_condenser.C_out, condenser.C_hot_in) annotation (Line(points={{139,100},
          {140,100},{140,86},{158,86},{158,32},{320,32},{320,100},{20,100},{20,
          34.6074}},                                                                                                                                                                color={217,67,180}));
  connect(bypass_superheater_to_condenser.C_in, superheater_control_valve.C_out) annotation (Line(points={{-113,
          134},{-113,80},{-767,80}},                                                                                                                 color={217,67,180}));
  connect(bypass_superheater_to_condenser.C_out, condenser.C_hot_in) annotation (Line(points={{-113,
          152},{-112,152},{-112,192},{20,192},{20,34.6074}},                                                                                        color={217,67,180}));
  connect(bypass_HP_turbine_ext_to_condenser.C_out, condenser.C_hot_in) annotation (Line(points={{-2,49},
          {4,49},{4,32},{320,32},{320,100},{20,100},{20,34.6074}},                                                                                             color={217,67,180}));
  connect(bypass_LP_heater_drains_to_condenser.C_out, condenser.C_hot_in) annotation (Line(points={{277,
          -150},{278,-150},{278,-162},{472,-162},{472,100},{20,100},{20,34.6074}},                                                                                              color={217,67,180}));
  connect(bypass_HP_heater_drains_to_condenser.C_out, condenser.C_hot_in) annotation (Line(points={{-16,
          -153},{-16,-162},{472,-162},{472,100},{20,100},{20,34.6074}},                                                                                              color={217,67,180}));
  connect(bypass_LP_turbine_to_condenser.C_in, LPT1.C_in) annotation (Line(points={{139,118},
          {140,118},{140,120},{-281,120}},                                                                                   color={217,67,180}));
  connect(bypass_HP_turbine_ext_to_condenser.C_in, HP_extract_P_sensor.C_in) annotation (Line(points={{-20,49},
          {-28,49},{-28,58},{-640,58},{-640,15}},                                                                                                    color={28,108,200}));
  connect(bypass_HP_control_valve_to_condenser.C_in, HP_control_valve.C_in) annotation (Line(points={{-147,60},
          {-148,60},{-148,39.9998},{-785,39.9998}},                                                                                            color={28,108,200}));
  connect(bypass_HP_turbine_to_condenser.C_in, HPT_P_in_sensor.C_in) annotation (Line(points={{-113,60},
          {-113,40},{-734,40}},                                                                                               color={28,108,200}));
  connect(bypass_LP_heater_drains_to_condenser.C_in, LP_reheater_drains_control_valve.C_in) annotation (Line(points={{277,
          -132},{276,-132},{276,-100},{-145,-100}},                                                                                                                        color={217,67,180}));
  connect(bypass_HP_heater_drains_to_condenser.C_in, HP_reheater_drains_control_valve.C_in) annotation (Line(points={{-16,
          -135},{-16,-100},{-565,-100}},                                                                                                                      color={28,108,200}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(coordinateSystem(preserveAspectRatio=false)));
end MetroscopiaNPP_faulty_MML4;
