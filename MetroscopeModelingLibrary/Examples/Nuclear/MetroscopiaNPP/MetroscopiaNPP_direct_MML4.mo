...
model MetroscopiaNPP_direct_MML4 "MML4 beta 2"
    ...
    Tsat_0=312.0976)                                                                       annotation (Placement(transformation(extent={{4.5,
            8.5432},{35.5,34.321}})));
  ...
  Sensors_Control.WaterSteam.PressureSensor                   CW_P_in_sensor(
    ...
    h_0=63e3,
    sensor_function="BC",
    P_start=3)                                                               annotation (Placement(transformation(extent={{-27,13},
            {-13,27}})));
  ...
  Utilities.Interfaces.RealOutput CW_T_out(start=25)
                                           annotation (Placement(transformation(
        extent={{-4,-4},{4,4}},
        rotation=270,
  ...
  Sensors_Control.WaterSteam.PressureSensor                   P_cond_sensor(
    ...
    P_start=0.0698,
    display_unit="barA",
    signal_unit="barA")                                                     annotation (Placement(transformation(extent={{-88,114},
            {-76,126}})));
  Utilities.Interfaces.RealOutput P_cond(
    ...
    h_out_0=164e3,
    Q_0=1060,
    W(start=0))                                                                     annotation (Placement(transformation(extent={{-24,-68},
            {-40,-52}})));
  ...
  Sensors_Control.WaterSteam.PressureSensor                   extraction_pump_P_out_sensor(
    ...
    P_start=6.9999995)                                                                     annotation (Placement(transformation(extent={{7,-7},{-7,7}}, origin={-80,-60})));
  ...
  WaterSteam.Machines.SteamTurbine                           LPT2(
    ...
    xm_0=0.9530399,
    x_in_0=0.97717774)
              annotation (Placement(transformation(extent={{-145,112},{-127,128}})));
  ...
  Utilities.Interfaces.RealOutput turbines_eta_is annotation (Placement(
    ...
    Power.Machines.Generator                           generator annotation (Placement(transformation(extent={{-108,
            148},{-68,172}})));
    Sensors_Control.Power.PowerSensor                   W_elec_sensor(
    W_MW(start=570),
    sensor_function="Calibration",
    causality="turbines_eta_is")                                      annotation (Placement(transformation(extent={{-68,154},
            {-56,166}})));
  Utilities.Interfaces.RealOutput W_elec(
                                        start=570) annotation (Placement(
        transformation(
        extent={{-4,-4},{4,4}},
        rotation=270,
    ...
    T_0=425.15,
    h_0=2700000.0,
    x_0=0.97717774)                                                               annotation (Placement(transformation(extent={{-210,
            110},{-190,128}})));
  ...
  Sensors_Control.WaterSteam.PressureSensor                   LP_heater_P_out_sensor(
    ...
    P_start=5.9999995)                                                               annotation (Placement(transformation(extent={{-223,
            -67},{-237,-53}})));
  ...
  WaterSteam.Machines.SteamTurbine                           LPT1(
    ...
    xm_0=0.98858887,
    x_in_0=1.0)
              annotation (Placement(transformation(extent={{-281,112},{-263,128}})));
  ...
  Utilities.Interfaces.RealExpression    deaerator_outlet_pipe_delta_z(y=-5)
    ...
    WaterSteam.Machines.FixedSpeedPump                 feedwater_pump                                 annotation (Placement(transformation(extent={{-506,
            -68},{-522,-52}})));
  ...
  Sensors_Control.WaterSteam.PressureSensor                   HP_pump_P_out_sensor(
    ...
    P_start=59)                                                                    annotation (Placement(transformation(extent={{7,-7},{-7,7}}, origin={-570,-60})));
  ...
  Sensors_Control.WaterSteam.TemperatureSensor                   HP_heater_T_out_sensor(
    ...
    T_start=210)                                                                        annotation (Placement(transformation(extent={{-723,
            -67},{-737,-53}})));
  Sensors_Control.WaterSteam.PressureSensor                   HP_heater_P_out_sensor(
    ...
    P_start=58)                                                                      annotation (Placement(transformation(extent={{-703,
            -67},{-717,-53}})));
  ...
  Utilities.Interfaces.RealOutput HP_heater_T_drains(
    ...
    WaterSteam.Pipes.ControlValve                           HP_reheater_drains_control_valve(
    T_in_0=300,
    T_out_0=300,
    P_in_0=100000,
    P_out_0=100000,
    ...
    T_0=300,
    h_0=500000.0,
    Cv(start=330.2112))                                                                      annotation (Placement(transformation(extent={{-565,
            -102.182},{-555,-90.182}})));
  ...
  Utilities.Interfaces.RealOutput HP_reheater_drains_control_valve_opening(
                                                                          start=15)
    annotation (Placement(transformation(
        extent={{-4,-4},{4,4}},
        rotation=270,
  ...
  Sensors_Control.WaterSteam.PressureSensor                   P_steam_sensor(
    ...
    h_0=2.778e6,
    sensor_function="BC",
    P_start=50)                                                              annotation (Placement(transformation(
        extent={{-7,7},{7,-7}},
        rotation=90,
        origin={-820,10})));
  ...
  WaterSteam.BoundaryConditions.Sink                           sink annotation (Placement(transformation(
        ...
        origin={-820,-140})));
  Utilities.Interfaces.BoundaryCondition
                                 thermal_power(start=2820, nominal=1e3)
    annotation (Placement(transformation(
        extent={{-4,-4},{4,4}},
        rotation=270,
        origin={-854,-42}), iconTransformation(extent={{-170,22},{-130,62}})));
  Utilities.Interfaces.BoundaryCondition
                                 P_steam(start=50) annotation (Placement(
        transformation(
        extent={{-4,-4},{4,4}},
        rotation=180,
        origin={-804,10}), iconTransformation(extent={{-170,22},{-130,62}})));
  Utilities.Interfaces.BoundaryCondition
                                 Q_purge(start=5) annotation (Placement(
        transformation(
        extent={{-4,-4},{4,4}},
        rotation=180,
    ...
    T_0=536.15,
    h_0=2.8e6,
    Cv(start=196329.05))                                                                                  annotation (Placement(transformation(extent={{-785,
            37.818},{-775,49.818}})));
  ...
  Sensors_Control.WaterSteam.PressureSensor                   HPT_P_in_sensor(
    ...
    sensor_function="Calibration",
    causality="HPT1_Cst",
    P_start=41)                                                               annotation (Placement(transformation(extent={{-734,34},
            {-722,46}})));
  ...
  Utilities.Interfaces.RealOutput HP_control_valve_opening(
                                                          start=15) annotation
    (Placement(transformation(
        extent={{-4,-4},{4,4}},
        rotation=270,
        origin={-780,68}),  iconTransformation(extent={{-170,22},{-130,62}})));
  Utilities.Interfaces.RealOutput HPT_P_in(
                                          start=48.5) annotation (Placement(
        transformation(
        extent={{-4,-4},{4,4}},
        rotation=270,
  ...
  WaterSteam.Machines.SteamTurbine                           HPT_1(
    ...
    xm_0=0.9710897,
    x_in_0=1.0)
              annotation (Placement(transformation(extent={{-697,32},{-679,48}})));
  ...
  Sensors_Control.WaterSteam.PressureSensor                   HP_extract_P_sensor(
    ...
    causality="HPT2_Cst")                                                         annotation (Placement(transformation(
        ...
        rotation=270,
        origin={-640,8})));
  Utilities.Interfaces.RealOutput HPT_extract_P(
                                               start=31) annotation (Placement(
        transformation(
        extent={{-4,-4},{4,4}},
        rotation=180,
    ...
    T_0=508.85,
    h_0=2.73e6,
    x_0=0.9589742)                                                                annotation (Placement(transformation(extent={{-650,30},
            {-630,48}})));
  WaterSteam.Machines.SteamTurbine                           HPT_2(
    ...
    xm_0=0.94844204,
    x_in_0=0.9589742)
              annotation (Placement(transformation(extent={{-587,32},{-569,48}})));
  Sensors_Control.WaterSteam.PressureSensor                   HPT_P_out_sensor(
    ...
    sensor_function="Calibration",
    causality="LPT1_Cst",
    P_start=19.4)                                                              annotation (Placement(transformation(extent={{-466,34},
            {-454,46}})));
  ...
  Utilities.Interfaces.RealOutput HPT2_Cst annotation (Placement(transformation(
    ...
    Q_in_0=1113,
    Q_liq_0=50,
    Q_vap_0=1063.0)                                                     annotation (Placement(transformation(extent={{-436,
            27.8182},{-420,45.8182}})));
  ...
  Sensors_Control.WaterSteam.PressureSensor                   superheater_bleed_P_sensor(
    ...
    causality="superheater_control_valve_Cv_max")                                        annotation (Placement(transformation(extent={{-746,74},
            {-734,86}})));
  Utilities.Interfaces.RealOutput superheater_bleed_P(
                                                     start=41) annotation (
      Placement(transformation(
        extent={{-4,-4},{4,4}},
        rotation=270,
  ...
  Utilities.Interfaces.RealOutput superheater_control_valve_Cv_max annotation (
    ...
    T_0=537.15,
    h_0=2.8e6,
    Cv(start=2646.496))                                                               annotation (Placement(transformation(extent={{-777,
            77.8182},{-767,89.818}})));
  Utilities.Interfaces.RealExpression condenser_C_incond(y=0)
    annotation (Placement(transformation(extent={{20,38},{40,58}})));
equation
  HPT1_Cst = 19833.12;
  HP_control_valve_Cvmax = 1018898.56;
  HP_heater_Kth_subc = 24935.426;
  HP_heater_Kfr_cold = 613.1878;
  HP_heater_Kth_cond =5378.917;
  feedwater_pump_rh =0.17008841;
  feedwater_pump_hn =554.21515;
  HP_heater_drains_control_valve_Cvmax = 413.89258;
  LP_heater_Kth = 11698.955;
  LP_heater_Kfr_cold = 86.936424;
  extraction_pump_hn = 70.18661;
  extraction_pump_rh = 0.89422244;
  LP_heater_drains_control_valve_Cvmax = 765.5487;
  condenser_Kth = 1234767.8;
  turbines_eta_is = 0.5380269;
  condenser_Q_cold = 54.699844;
  superheater_control_valve_Cv_max = 2432.2764;
  LPT1_Cst = 6138.982;
  LPT2_Cst = 583.82635;
  HPT2_Cst = 9483.176;
  superheater_Kth= 16532.688;
