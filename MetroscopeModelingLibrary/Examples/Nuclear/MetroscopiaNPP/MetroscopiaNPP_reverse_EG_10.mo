...
model MetroscopiaNPP_reverse_EG_10
  ...
  Modelica.Blocks.Sources.RealExpression deaerator_inlet_pipe_delta_z(y=5)
    annotation (Placement(transformation(extent={{-416,-56},{-396,-36}})));
  ...
  Modelica.Blocks.Sources.RealExpression deaerator_outlet_pipe_delta_z(y=-5)
    annotation (Placement(transformation(extent={{-482,-56},{-462,-36}})));
  ...
  WaterSteam.HeatExchangers.Superheater superheater
    ...
    WaterSteam.BoundaryConditions.Source rh_hot_in annotation (Placement(
        ...
        rotation=0,
        origin={-810,80})));
  Modelica.Blocks.Sources.RealExpression superheater_Kfr_cold(y=0)
    annotation (Placement(transformation(extent={{-442,100},{-422,120}})));
...
equation
  // BC LOCALES
  rh_hot_in.T_out = P_steam_sensor.flow_model.T;
  ...
  connect(deaerator_inlet_pipe_delta_z.y, deaerator_inlet_pipe.delta_z)
    annotation (Line(points={{-395,-46},{-390,-46},{-390,-56}}, color={0,0,127}));
  ...
  connect(deaerator_outlet_pipe_delta_z.y, deaerator_outlet_pipe.delta_z)
    annotation (Line(points={{-461,-46},{-456,-46},{-456,-56}}, color={0,0,127}));
  ...
  connect(superheater.Kfr_cold, superheater_Kfr_cold.y) annotation (Line(points={{-406,90},
          {-406,110},{-421,110}},                       color={0,0,127}));
  ...
  connect(rh_hot_in.C_out, superheater_bleed_P_sensor.C_in)
    annotation (Line(points={{-805,80},{-746,80}}, color={28,108,200}));
...
end MetroscopiaNPP_reverse_EG_10;
