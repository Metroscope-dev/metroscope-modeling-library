...
model MetroscopiaNPP_internal_ramp_direct
 ...
 // Boundary condition initialisation state
  ...
  MetroscopeModelingLibrary.WaterSteam.Pipes.LoopBreaker loopBreaker annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-142,-70})));
  Power.BoundaryConditions.Source source annotation (Placement(transformation(extent={{-220,-80},{-200,-60}})));
equation
  ...
  connect(steam_generator.C_thermal_power, source.C_out) annotation (Line(points={{-181,-70},{-205.2,-70}}, color={244,125,35}));
