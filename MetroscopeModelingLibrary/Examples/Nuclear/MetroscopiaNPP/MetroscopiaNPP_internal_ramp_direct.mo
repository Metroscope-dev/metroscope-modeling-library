...
equation
  ...
  connect(superheater.C_cold_in,steam_dryer.C_out_steam)  annotation (Line(points={{72,104},{72,91.2727}},              color={28,108,200}));
  ...
  connect(steam_dryer.C_out_liquid, steam_dryer_liq_out_pipe.C_in) annotation (Line(points={{72,84.7273},{72,-34},{142,-34},{142,-40}},
                                                                                                                                     color={28,108,200}));
