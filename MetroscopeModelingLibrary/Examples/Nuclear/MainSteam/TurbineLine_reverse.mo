...
model TurbineLine_reverse
  ...
  input Real ST1_ext_P(start=41, unit="bar", nominal=20, min=0, max=200) "barA";
  input Real ST2_ext_P(start=28, unit="bar", nominal=20, min=0, max=200) "barA";
  input Real ST3_ext_P(start=16, unit="bar", nominal=20, min=0, max=200) "barA";

  input Real W_tot(start=320) "MW";
