...
model TurbineLPCondenser_reverse_step1
  ...
  input Real LP_turbine1_ext_P(start=5.6, unit="bar", nominal=20, min=0, max=200) "barA";
  input Real LP_turbine2_ext_P(start=1.75, unit="bar", nominal=20, min=0, max=200) "barA";
  ...
  // Turbines
  output Units.Cst LP_turbine1_Cst;
  ...
  WaterSteam.Machines.SteamTurbineWithNozzle LP_turbine3(P_in_0=150000, P_out_0=5080) annotation (Placement(transformation(extent={{38,-10},{58,10}})));
...
equation
  ...
  annotation (Diagram(coordinateSystem(extent={{-180,-140},{200,140}})), Icon(coordinateSystem(extent={{-100,-100},{100,100}}), graphics={
        ...
        Rectangle(
          ...
          fillPattern=FillPattern.Solid,
          pattern=LinePattern.None)}));
end TurbineLPCondenser_reverse_step1;
