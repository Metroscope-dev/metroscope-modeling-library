...
Finally, I swapped rh and hn for the extraction sensors: the extraction pressure sensor should use hn, while the extraction temperature sensor should use rh. These were incorrectly defined in the library."
    ...
    Sensors_Control.Power.PowerSensor thermal_power_sensor(sensor_function="BC") annotation (Placement(transformation(extent={{-852,
              -10},{-832,10}})));
    ...
    Sensors_Control.WaterSteam.TemperatureSensor HP_heater_T_out_sensor(
      ...
      T_start=210)                                                                   annotation (Placement(transformation(extent={{-666,-10},{-686,10}})));
    Sensors_Control.WaterSteam.PressureSensor HP_heater_P_out_sensor(
      sensor_function="Calibration",
      causality="HP_heater_Kfr_cold",
      P_start=58)                                                                annotation (Placement(transformation(extent={{-636,-10},{-656,10}})));
    Sensors_Control.WaterSteam.FlowSensor Q_feedwater_sensor(Q_start=1500) annotation (Placement(transformation(extent={{-606,-10},{-626,10}})));
    ...
    WaterSteam.BoundaryConditions.Sink sink_purge(Q_in(start=5), Qv_in(start=
            0.0064317323))                        annotation (Placement(transformation(
          extent={{-20,-20},{20,20}},
          rotation=270,
          origin={-780,-144})));
    ...
    WaterSteam.Machines.SteamTurbine HPT_1(
      ...
      W(start=-64914788),
      xm_0=0.9710897,
      x_in_0=1.0)                          annotation (Placement(transformation(extent={{-600,240},{-520,320}})));
    ...
    WaterSteam.Machines.SteamTurbine HPT_2(
      ...
      W(start=-49711764),
      xm_0=0.94844204,
      x_in_0=0.9589742)                    annotation (Placement(transformation(extent={{-398,
              240},{-318,320}})));
    WaterSteam.Pipes.SteamExtractionSplitter HP_extract(
      ...
      T_0=508.85,
      h_0=2730000.0,
      x_0=0.9589742)                                    annotation (Placement(transformation(extent={{-480,260},{-440,300}})));
    Power.BoundaryConditions.Sink sink2 annotation (Placement(transformation(extent={{464,380},{504,420}})));
    Power.Machines.Generator generator(eta=0.99)
    ...
    Sensors_Control.Power.PowerSensor W_elec_sensor(sensor_function="Calibration", causality="turbines_eta_is",
      W_start=570)                                  annotation (Placement(transformation(extent={{358,390},{378,410}})));
    ...
    WaterSteam.HeatExchangers.Reheater reheater(
      ...
      h_hot_out_0=379000.0)                     annotation (Placement(transformation(extent={{-412,-24},{-508,24}})));
    ...
    Sensors_Control.WaterSteam.PressureSensor LP_heater_P_out_sensor(
      ...
      P_start=5.9999995)                                                        annotation (Placement(transformation(extent={{56,-10},{36,10}})));
    Utilities.Interfaces.CalibrationInput
    ...
    WaterSteam.Volumes.SteamDryer steamDryer(
      ...
      Q_in_0=1113.0,
      Q_liq_0=50.0,
      Q_vap_0=1063.0)                        annotation (Placement(transformation(extent={{-223,
              85.4545},{-173,139.455}})));
    ...
    WaterSteam.Pipes.HeightVariationPipe deaerator_outlet_pipe(
      ...
      T_0=350.05,
      h_0=322000.0,
      delta_z(start=-5))                                       annotation (Placement(transformation(extent={{-190,-10},{-210,10}})));
    WaterSteam.Pipes.HeightVariationPipe deaerator_inlet_pipe(
      ...
      T_0=338.15,
      h_0=272000.0,
      delta_z(start=5))                                       annotation (Placement(transformation(extent={{-110,-10},{-130,10}})));
    ...
    Sensors_Control.WaterSteam.TemperatureSensor superheater_T_out_sensor(
      sensor_function="Calibration",
      causality="superheater_Kth",                                        T_start=228) annotation (Placement(transformation(
          extent={{-10,-10},{10,10}},
          rotation=90,
          origin={-80,230})));
    Utilities.Interfaces.CalibrationInput
                                   superheater_T_out annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=0,
          origin={-100,230}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    WaterSteam.Machines.SteamTurbine LPT_1(
      T_in_0=501.15,
      T_out_0=425.15,
      P_in_0=1940000,
      P_out_0=500000,
      ...
      W(start=-143588900),
      xm_0=0.98858887,
      x_in_0=1.0)                          annotation (Placement(transformation(extent={{-22,240},
              {58,320}})));
    ...
    WaterSteam.Machines.SteamTurbine LPT_2(
      ...
      W(start=-317542100),
      xm_0=0.9530399,
      x_in_0=0.97717774)                   annotation (Placement(transformation(extent={{180,240},{260,320}})));
    Sensors_Control.WaterSteam.PressureSensor P_cond_sensor(sensor_function="Calibration", causality="condenser_Kth",
      P_start=0.0698)                                       annotation (Placement(transformation(extent={{350,270},{370,290}})));
    ...
    WaterSteam.HeatExchangers.DryReheater dryReheater(
      ...
      h_hot_out_0=640000.0)                           annotation (Placement(transformation(extent={{168,-24},{72,24}})));
    Sensors_Control.WaterSteam.PressureSensor extraction_pump_T_out_sensor(
      sensor_function="Calibration",
      causality="extraction_pump_hn",
      P_start=6.9999995)                                                              annotation (Placement(transformation(extent={{250,-10},
              {230,10}})));
    Sensors_Control.WaterSteam.TemperatureSensor extraction_pump_P_out_sensor(
      sensor_function="Calibration",
      causality="extraction_pump_rh",                                         T_start=39) annotation (Placement(transformation(extent={{218,-10},{198,10}})));
    Utilities.Interfaces.CalibrationInput
    ...
    WaterSteam.Pipes.ControlValve LP_reheater_drains_control_valve(
      ...
      T_0=425.15,
      h_0=640000.0,
      Cv(start=227.55151))                                         annotation (Placement(transformation(extent={{210,-124},{230,-104}})));
    WaterSteam.HeatExchangers.Condenser condenser(
      ...
      Tsat_0=312.0976)                            annotation (Placement(transformation(extent={{572,40},
              {672,140}})));
    WaterSteam.BoundaryConditions.Source source4 annotation (Placement(transformation(extent={{814,78},
              {774,118}})));
    WaterSteam.BoundaryConditions.Sink sink4(Q_in(start=54232.63), Qv_in(start=
            54.388317))                      annotation (Placement(transformation(extent={{780,22},{820,62}})));
    ...
    WaterSteam.Machines.FixedSpeedPump extraction_pump(
      ...
      h_out_0=164000.0,
      Q_0=1060.0,
      W(start=0))                                      annotation (Placement(transformation(extent={{422,-20},{382,20}})));
    ...
    WaterSteam.HeatExchangers.Superheater superheater(
      ...
      h_hot_out_0=1090000.0)                          annotation (Placement(transformation(extent={{-128,136},{-32,184}})));
    WaterSteam.Pipes.PressureCut pressureCut3(
      T_in_0=300,
      T_out_0=300,
      P_in_0=100000,
      P_out_0=100000,
      ...
      T_0=300,
      h_0=500000.0,
      DP_input(start=-899999.94))             annotation (Placement(transformation(extent={{-10,150},{10,170}})));
    WaterSteam.Pipes.PressureCut pressureCut4(
      T_in_0=300,
      T_out_0=300,
      P_in_0=100000,
      P_out_0=100000,
      ...
      T_0=300,
      h_0=500000.0,
      DP_input(start=0))                      annotation (Placement(transformation(extent={{-10,126},{10,146}})));
    WaterSteam.Pipes.ControlValve controlValve(
      T_in_0=536.15,
      T_out_0=536.15,
      P_in_0=5000000,
      P_out_0=4850000,
      ...
      T_0=536.15,
      h_0=2800000.0,
      Cv(start=196329.05))                     annotation (Placement(transformation(extent={{-710,276},{-690,296}})));
    WaterSteam.Pipes.SlideValve slideValve(
      T_in_0=537.15,
      T_out_0=537.15,
      P_in_0=5000000,
      P_out_0=4100000,
      ...
      T_0=537.15,
      h_0=2800000.0,
      Cv(start=2646.496))                  annotation (Placement(transformation(extent={{-710,156},{-690,178}})));
    ...
    Sensors_Control.Outline.OpeningSensor HP_control_valve_opening_sensor(sensor_function="Calibration", causality="HP_control_valve_Cvmax",
      Opening_start=14.999998,
      signal_unit="%")                                                                                                                       annotation (Placement(transformation(extent={{-710,310},{-690,330}})));
    ...
    Sensors_Control.Outline.OpeningSensor LP_reheater_drains_control_valve_opening_sensor(sensor_function="Calibration", causality="LP_heater_drains_control_valve_Cvmax",
      Opening_start=14.999999,
      signal_unit="%")                                                                                                                                                     annotation (Placement(transformation(extent={{210,-90},{230,-70}})));
    ...
    Sensors_Control.Outline.OpeningSensor HP_reheater_drains_control_valve_opening_sensor(sensor_function="Calibration", causality="HP_heater_drains_control_valve_Cvmax",
      Opening_start=15,
      signal_unit="%")                                                                                                                                                     annotation (Placement(transformation(extent={{-310,
              -86},{-290,-66}})));
    ...
    Utilities.Interfaces.RealOutput superheater_control_valve_Cv_max annotation (
        Placement(transformation(extent={{-726,168},{-718,176}}),
    ...
    Utilities.Interfaces.RealOutput superheater_Kth annotation (Placement(
          transformation(extent={{-138,188},{-130,196}}), iconTransformation(
            extent={{-294,202},{-274,222}})));
  equation
  //   sink3.Q_in = 70;
  ...
  //   source3.h_out = 2711154;
    ...
    connect(HPT_1.C_out, HP_extract.C_in) annotation (Line(points={{-520,280},{-481.2,280}}, color={238,46,47},
        thickness=1,
        pattern=LinePattern.Dash));
    connect(HP_extract.C_main_out, HPT_2.C_in) annotation (Line(points={{-438.8,
            280},{-398,280}},                                                                     color={238,46,47},
        thickness=1,
        pattern=LinePattern.Dash));
    ...
    connect(HP_extract.C_ext_out, HP_extract_P_sensor.C_in) annotation (Line(points={{-460,266.4},{-460,120}}, color={238,46,47},
        pattern=LinePattern.Dash,
        thickness=0.5));
    connect(HPT_1.eta_is, HPT_2.eta_is) annotation (Line(points={{-568,248},{
            -568,200},{-366,200},{-366,248}},                                                                  color={0,0,127}));
    ...
    connect(LPT_1.eta_is,LPT_2. eta_is) annotation (Line(points={{10,248},{10,
    ...
    connect(LPT_1.C_in, superheater_T_out_sensor.C_out) annotation (Line(points={{-22,280},
        ...
        thickness=1,
        pattern=LinePattern.Dash));
    connect(LPT_1.C_out, LP_extract.C_in) annotation (Line(points={{58,280},{
            98.8,280}},                                                                  color={244,125,35},
        thickness=1,
        pattern=LinePattern.Dash));
    ...
    connect(HPT_2.eta_is, LPT_2.eta_is) annotation (Line(points={{-366,248},{
            -366,200},{212,200},{212,248}},                                                                  color={0,0,127}));
    ...
    connect(HPT_2.Cst, HPT2_Cst) annotation (Line(points={{-382,252},{-382,220},
            {-400,220}},                                                                     color={0,0,127}));
    connect(LPT_1.Cst, LPT1_Cst) annotation (Line(points={{-6,252},{-6,220},{
            -20,220}},                                                                  color={0,0,127}));
    connect(LPT_2.Cst, LPT2_Cst) annotation (Line(points={{196,252},{196,220},{180,220}}, color={0,0,127}));
    connect(condenser.Kth, condenser_Kth) annotation (Line(points={{570,100},{
            500,100}},                                                                   color={0,0,127}));
  ...
  model MetroscopiaNPP_direct_MML4
    ...
    Utilities.Interfaces.Observable Q_feedwater annotation (Placement(transformation(
          ...
          rotation=270,
          origin={-616,20}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    Utilities.Interfaces.RealOutput HP_heater_P_out
                                                   annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
          origin={-646,20}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    Utilities.Interfaces.RealOutput HP_heater_T_out
                                                   annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
          origin={-676,20}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    WaterSteam.BoundaryConditions.Sink sink_purge(Q_in(start=5), Qv_in(start=0.0064317323))
                                                  annotation (Placement(transformation(
          extent={{-20,-20},{20,20}},
          rotation=270,
          origin={-780,-144})));
    ...
    Utilities.Interfaces.RealExpression realExpression(y=1) annotation (Placement(transformation(
          ...
          rotation=0,
          origin={-444,298}), iconTransformation(extent={{-656,182},{-616,222}})));
    Utilities.Interfaces.RealOutput HP_extract_P
                                                annotation (Placement(transformation(extent={{-416,106},{-424,114}}), iconTransformation(extent={{-814,98},{-774,138}})));
    Utilities.Interfaces.RealOutput W_elec(
                                          start=570) annotation (Placement(transformation(
          extent={{4,-4},{-4,4}},
          rotation=90,
          origin={368,428}),
                           iconTransformation(extent={{-814,98},{-774,138}})));
    Sensors_Control.WaterSteam.PressureSensor HPT_extract_P1_sensor(
      ...
      causality="LPT1_Cst",                                         P_start=19.4) annotation (Placement(transformation(
          ...
          rotation=0,
          origin={-260,280})));
    Utilities.Interfaces.RealOutput HPT_extract_P1
                                                  annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
          origin={-260,310}), iconTransformation(extent={{-804,180},{-764,220}})));
    ...
    Sensors_Control.WaterSteam.PressureSensor HP_pump_P_out_sensor(
      sensor_function="Calibration",
      causality="feedwater_pump_hn",                               P_start=59) annotation (Placement(transformation(extent={{-330,-10},{-350,10}})));
    Utilities.Interfaces.RealOutput HP_pump_P_out
                                                 annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
          origin={-340,20}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    Utilities.Interfaces.RealOutput HP_pump_T_out
                                                 annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
          origin={-370,20}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    Sensors_Control.WaterSteam.TemperatureSensor HP_heater_T_drains_sensor(
      ...
      causality="HP_heater_Kth_cond",                                      T_start=90) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-460,-60})));
    Utilities.Interfaces.RealOutput HP_heater_T_drains
                                                      annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=0,
          origin={-486,-60}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    ...
    Sensors_Control.WaterSteam.PressureSensor LP_heater_P_out_sensor(
      ...
      causality="LP_heater_Kfr_cold",
      P_start=5.9999995)                                                        annotation (Placement(transformation(extent={{56,-10},{36,10}})));
    Utilities.Interfaces.RealOutput LP_heater_P_out
                                                   annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
          origin={46,20}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    Utilities.Interfaces.RealOutput LP_heater_T_out
                                                   annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
          origin={16,20}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    ...
    Sensors_Control.WaterSteam.TemperatureSensor superheater_T_out_sensor(
      ...
      causality="superheater_Kth",                                        T_start=228) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-80,230})));
    Utilities.Interfaces.RealOutput superheater_T_out
                                                     annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=0,
          origin={-100,230}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    ...
    Sensors_Control.WaterSteam.PressureSensor LP_extract_P_sensor(
      ...
      P_start=5)                                                             annotation (Placement(transformation(
          ...
          rotation=270,
          origin={120,170})));
    Utilities.Interfaces.RealOutput LP_extract_P
                                                annotation (Placement(transformation(
          extent={{4,-4},{-4,4}},
          rotation=0,
          origin={148,170}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    ...
    Sensors_Control.WaterSteam.TemperatureSensor extraction_pump_P_out_sensor(
      sensor_function="Calibration",
      causality="extraction_pump_rh",                                         T_start=39) annotation (Placement(transformation(extent={{218,-10},{198,10}})));
    Utilities.Interfaces.RealOutput extraction_pump_P_out
                                                         annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
          origin={208,20}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    Utilities.Interfaces.RealOutput extraction_pump_T_out
                                                         annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
          origin={238,20}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    ...
    WaterSteam.BoundaryConditions.Source source4 annotation (Placement(transformation(extent={{814,78},
              {774,118}})));
    WaterSteam.BoundaryConditions.Sink sink4(Q_in(start=54232.63), Qv_in(start=54.388317))
    ...
    Sensors_Control.WaterSteam.TemperatureSensor CW_T_out_sensor(
      sensor_function="Calibration",
      causality="condenser_Qv_cold",                             T_start=25) annotation (Placement(transformation(extent={{704,80},{724,60}})));
    Utilities.Interfaces.RealOutput CW_T_out
                                            annotation (Placement(transformation(
          extent={{4,-4},{-4,4}},
          rotation=270,
          origin={714,40}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    ...
    Sensors_Control.WaterSteam.PressureSensor HPT_P_in_sensor(
      ...
      causality="HPT1_Cst",
      P_start=48.5) annotation (Placement(transformation(extent={{-650,270},{-630,290}})));
    Utilities.Interfaces.RealOutput       HPT_P_in annotation (Placement(transformation(
          extent={{-4,4},{4,-4}},
          rotation=270,
          origin={-640,300}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    Sensors_Control.WaterSteam.PressureSensor superheater_bleed_P_sensor(
      ...
      causality="superheater_control_valve_Cv_max",
      P_start=41) annotation (Placement(transformation(extent={{-652,150},{-632,170}})));
    Utilities.Interfaces.RealOutput       superheater_bleed_P annotation (Placement(transformation(
          extent={{-4,4},{4,-4}},
          rotation=270,
          origin={-642,180}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    Sensors_Control.Outline.OpeningSensor HP_control_valve_opening_sensor(sensor_function="Calibration", causality="HP_control_valve_Cvmax",
      Opening_start=14.999998,
      signal_unit="%")                                                                                                                       annotation (Placement(transformation(extent={{-710,310},{-690,330}})));
    Utilities.Interfaces.RealOutput       HP_control_valve_opening(start=15) annotation (Placement(transformation(
          extent={{-4,4},{4,-4}},
          rotation=270,
          origin={-700,342}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    Sensors_Control.Outline.OpeningSensor LP_reheater_drains_control_valve_opening_sensor(sensor_function="Calibration", causality="LP_heater_drains_control_valve_Cvmax",
      Opening_start=14.999999,
      signal_unit="%")                                                                                                                                                     annotation (Placement(transformation(extent={{210,-90},{230,-70}})));
    Utilities.Interfaces.RealOutput       LP_reheater_drains_control_valve_opening(start=15) annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
          origin={220,-60}), iconTransformation(extent={{82,-132},{122,-92}})));
    Sensors_Control.Outline.OpeningSensor HP_reheater_drains_control_valve_opening_sensor(sensor_function="Calibration", causality="HP_heater_drains_control_valve_Cvmax",
      ...
      signal_unit="%")                                                                                                                                                     annotation (Placement(transformation(extent={{-310,
              -86},{-290,-66}})));
    Utilities.Interfaces.RealOutput       HP_reheater_drains_control_valve_opening(start=15) annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
          origin={-300,-58}), iconTransformation(extent={{82,-132},{122,-92}})));
    Utilities.Interfaces.RealOutput HP_control_valve_Cvmax annotation (Placement(transformation(extent={{-728,288},{-720,296}}), iconTransformation(extent={{-788,294},{-768,314}})));
