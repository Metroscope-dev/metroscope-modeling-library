...
model PowerSensor
  ...
  MetroscopeModelingLibrary.Power.Connectors.Outlet C_out(not_used = 0) annotation (Placement(transformation(extent={{88,-10},{108,10}}), iconTransformation(extent={{88,-10},{108,10}})));
equation
