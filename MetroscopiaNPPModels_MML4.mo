within ;
package MetroscopiaNPPModels_MML4
  model MetroscopiaNPP_reverse_MML4 "Version : MML4I noticed that the initial component values in the direct NPP model in the examples folder differed significantly from those in the reverse model. This may explain the discrepancies we observed in the calibrated parameter values, so I aligned them.
...
Finally, I swapped rh and hn for the extraction sensors: the extraction pressure sensor should use hn, while the extraction temperature sensor should use rh. These were incorrectly defined in the library."
    ...
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput HP_heater_P_out
      annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
          origin={-646,20}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput HP_heater_T_out
      annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
    ...
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput HP_extract_P
      annotation (Placement(transformation(extent={{-416,106},{-424,114}}),
          iconTransformation(extent={{-814,98},{-774,138}})));
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput W_elec(start=570)
      annotation (Placement(transformation(
          extent={{4,-4},{-4,4}},
          rotation=90,
    ...
    MetroscopeModelingLibrary.Sensors_Control.WaterSteam.PressureSensor HPT_extract_P1_sensor(
      ...
      P_start=19.4) annotation (Placement(transformation(
          ...
          rotation=0,
          origin={-260,280})));
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput HPT_extract_P1
      annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
    ...
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput HP_pump_P_out
      annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
          origin={-340,20}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput HP_pump_T_out
      annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
    ...
    MetroscopeModelingLibrary.Sensors_Control.WaterSteam.TemperatureSensor HP_heater_T_drains_sensor(
      ...
      T_start=90) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-460,-60})));
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput HP_heater_T_drains
      annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=0,
    ...
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput LP_heater_P_out
      annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
          origin={46,20}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput LP_heater_T_out
      annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
    ...
    MetroscopeModelingLibrary.Sensors_Control.WaterSteam.TemperatureSensor superheater_T_out_sensor(
      ...
      T_start=228) annotation (Placement(transformation(
          ...
          rotation=90,
          origin={-80,230})));
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput superheater_T_out
      annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=0,
    ...
    MetroscopeModelingLibrary.Sensors_Control.WaterSteam.PressureSensor LP_extract_P_sensor(
      ...
      P_start=5) annotation (Placement(transformation(
          ...
          rotation=270,
          origin={120,170})));
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput LP_extract_P
      annotation (Placement(transformation(
          extent={{4,-4},{-4,4}},
          rotation=0,
          origin={148,170}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput P_cond
      annotation (Placement(transformation(
          extent={{4,-4},{-4,4}},
          rotation=90,
    ...
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput extraction_pump_P_out
      annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
          origin={208,20}), iconTransformation(extent={{-978,-52},{-938,-12}})));
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput extraction_pump_T_out
      annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
    ...
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput CW_T_out
      annotation (Placement(transformation(
          extent={{4,-4},{-4,4}},
          rotation=270,
    ...
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput HPT_P_in
      annotation (Placement(transformation(
          extent={{-4,4},{4,-4}},
          rotation=270,
    ...
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput superheater_bleed_P
      annotation (Placement(transformation(
          extent={{-4,4},{4,-4}},
          rotation=270,
    ...
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput HP_control_valve_opening(start=15)
      annotation (Placement(transformation(
          extent={{-4,4},{4,-4}},
          rotation=270,
    ...
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput LP_reheater_drains_control_valve_opening(start=15)
      annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
    ...
    MetroscopeModelingLibrary.Utilities.Interfaces.CalibrationInput HP_reheater_drains_control_valve_opening(start=15)
      annotation (Placement(transformation(
          extent={{-4,-4},{4,4}},
          rotation=270,
  ...
  end MetroscopiaNPP_reverse_MML4;

  model MetroscopiaNPP_direct_MML4
    "Version: MML4I verified the initial values in the reverse model, retrieved the calibrated parameter values, applied them to the direct model, and ran it successfully. Everything is now working as expected with the corrections in place."
    MetroscopeModelingLibrary.Power.BoundaryConditions.Source source
      annotation (Placement(transformation(extent={{-900,-20},{-860,20}})));
    MetroscopeModelingLibrary.Sensors_Control.Power.PowerSensor thermal_power_sensor(
        sensor_function="BC")
  ...
  annotation (uses(MetroscopeModelingLibrary(version="4.0.0-beta")));
end MetroscopiaNPPModels_MML4;
